...
/**
 * @namespace
 * @exports TargetNS as BuzzDesk.Form.Input
 */
BuzzDesk.Form.Input = (function (TargetNS) {
    ...
    Adds a field mapping to an Action.
        ...
        var Result = BuzzDesk.Form.Input.FieldIDMapping('AdminQueue',
            {
    ...
    */
    ...
    Returns the value(s) of input field.
        ...
        var Result = BuzzDesk.Form.Input.Get('Queue',
            {
                KeyOrValue: 'Value',
            }
        );
    ...
    */
    TargetNS.Get = function (Attribute, Options) {
        ...
        // BuzzDesk.Form.Input.Get('DynamicField_DateName');
        // BuzzDesk.Form.Input.Get('Year',{Type: 'PendingDate'});
        else if (
            ...
            // BuzzDesk.Form.Input.Get('DynamicField_Datum',{TimeStamp: 1});
    ...
    Returns the type of input field.
        ...
        var Type = BuzzDesk.Form.Input.Type('Queue');
    ...
    */
    ...
    Set value or key of input field.
        ...
        var Success = BuzzDesk.Form.Input.Set('Queue',
            'Postmaster',
            {
    ...
    */
    TargetNS.Set = function (Attribute, Content, Options) {
        ...
        if (FieldID === 'RichText' || Type == 'RichText') {
            ...
            if (
                ...
                Core.App.Publish('BuzzDesk.Form.Input.Change.'+ Attribute);
            }
            else {
                $('#'+ FieldID).val(Content || '');
                if (TriggerChange) {
        ...
        )
        {
            ...
            if ($.isArray(Content)) {
                ...
                $('input[name=\'' + FieldID + '\']').each(function() {
                    ...
                    Core.App.Publish('BuzzDesk.Form.Input.Change.' + Attribute + '.' + CheckboxValue);
                });
            }
            else {
        ...
        // DynamicField Date or DateTime
            ...
            // BuzzDesk.Form.Input.Set('DynamicField_DateTime','2020-11-25 14:22:00');
            ...
            // BuzzDesk.Form.Input.Set('DynamicField_Date',{Year: 2022, Month: 2, Day: 15, Hour: 10, Minute: 50, Used: true});
            if (Content['Year']){
                $.each(['Year', 'Month', 'Day', 'Hour', 'Minute'], function (Index, Suffix) {
        ...
        // if you use explicit Type: 'PendingDate' in Options
            ...
            // BuzzDesk.Form.Input.Set('Year','2020-11-25 14:22:00',{Type: 'PendingDate'});
            if(!Content['Year'] && $.type(Content) === "string"){
                var DateObject = new Date(Content);
            ...
            // BuzzDesk.Form.Input.Set('Year',{Year: 2022, Month: 2, Day: 15, Hour: 10, Minute: 50, Used: true},{Type: 'PendingDate'});
            if (Content['Year']){
                $.each(['Year', 'Month', 'Day', 'Hour', 'Minute'], function (Index, Suffix) {
    ...
    var Result = BuzzDesk.Form.Input.Mandatory('DynamicField_Example', true);
    var Result = BuzzDesk.Form.Input.Mandatory('DynamicField_Example', false);
    ...
    var CurrentState = BuzzDesk.Form.Input.Mandatory('DynamicField_Example');
    ...
    */
    ...
    var Result = BuzzDesk.Form.Input.Readonly('DynamicField_Example', true);
    var Result = BuzzDesk.Form.Input.Readonly('DynamicField_Example', false);
    ...
    var CurrentState = BuzzDesk.Form.Input.Readonly('DynamicField_Example');
    ...
    */
    ...
    var Result = BuzzDesk.Form.Input.Error('DynamicField_Example', 'Error');
    var Result = BuzzDesk.Form.Input.Error('DynamicField_Example', 'ServerError');
    ...
    */
    ...
    var Result = BuzzDesk.Form.Input.RichTextConfig({
        'RichText': {
    ...
    */
    ...
    TargetNS.RichTextConfig = function (NewConfig) {
        ...
        CKEDITOR.replaceBuzzDeskFormInput = CKEDITOR.replace;
        CKEDITOR.replace = function(EditorID, EditorConfig) {
            ...
            return CKEDITOR.replaceBuzzDeskFormInput(EditorID, EditorConfig);
        };
        ...
        // remove hack
        CKEDITOR.replace = CKEDITOR.replaceBuzzDeskFormInput;
        delete CKEDITOR.replaceBuzzDeskFormInput;
    ...
    var Success = BuzzDesk.Form.Input.MagicSideBarAddHTML(HTML);
