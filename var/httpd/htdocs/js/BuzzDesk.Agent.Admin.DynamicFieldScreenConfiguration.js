...
/**
 * @namespace
 * @exports TargetNS as BuzzDesk.Agent.Admin.DynamicFieldScreenConfiguration
 */
BuzzDesk.Agent.Admin.DynamicFieldScreenConfiguration = (function (TargetNS) {
    ...
    return TargetNS;
}(BuzzDesk.Agent.Admin.DynamicFieldScreenConfiguration || {}));
