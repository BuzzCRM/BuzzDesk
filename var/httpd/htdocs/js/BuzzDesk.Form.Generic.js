...
/**
 * @namespace BuzzDesk.Form.Generic
 * @memberof BuzzDesk.Form
 * @author BuzzDesk GmbH
 */
BuzzDesk.Form.Generic = (function (TargetNS) {

    var RestoreElements = {};

    /**
     * @name Init
     * @memberof BuzzDesk.Form.Generic
     * @function
     * @description
    ...
    TargetNS.Add = function (AddElement) {
        ...
        Core.App.Publish('BuzzDesk.Form.Generic.Add', [Param]);
    ...
    TargetNS.Remove = function (RemoveElement){
        ...
        if ($Destination){
            ...
            Param['Counter'] = Counter;
            Core.App.Publish('BuzzDesk.Form.Generic.Remove', [Param]);
        }
