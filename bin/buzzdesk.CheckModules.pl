...
our $OSDist;
eval {
    require Linux::Distribution;    ## nofilter(TidyAll::Plugin::BuzzDesk::Perl::Require)
...
# check needed params
if ($Help) {
    print "\nReturn all required and optional packages of BuzzDesk.\n\n";
    print "Usage:\n";
    print " buzzdesk.CheckModules.pl [-list|all]\n\n";
    print "Options:\n";
    printf " %-22s - %s", '[-list]', 'Return an install command with all required packages.' . "\n";
    printf " %-22s - %s", '[-all]',  'Return all required, optional and bundled packages of BuzzDesk.' . "\n\n";
    exit 1;
}
...
my @NeededModules = (
    ...
    },
    {
        Module    => 'Template',
        Required  => 1,
        Comment   => 'Template::Toolkit, the rendering engine of BuzzDesk.',
        InstTypes => {
