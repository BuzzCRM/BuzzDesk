...
package scripts::Migration::BuzzDesk::UpgradeDatabaseStructure;    ## no critic
...
sub Run {
    ...
    for my $Task (@Tasks) {
        ...
        my $ModuleName = "scripts::Migration::BuzzDesk::UpgradeDatabaseStructure::$Task->{Module}";
        ...
        $Kernel::OM->ObjectParamAdd(
            "scripts::Migration::BuzzDesk::UpgradeDatabaseStructure::$Task->{Module}" => {
