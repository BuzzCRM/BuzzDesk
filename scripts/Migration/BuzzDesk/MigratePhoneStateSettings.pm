...
package scripts::Migration::BuzzDesk::MigratePhoneStateSettings;    ## no critic
...
sub CheckPreviousRequirement {
    ...
    The following SysConfig settings have changed from BuzzDesk 7.2 to 7.3:

    OLD FORMAT (BuzzDesk 7.2):
