...
my $ChecksumFileNotPresent = sub {
    $Self->False(
        1,
        'Archive unit test requires the checksum file (ARCHIVE) to be present and valid. Please first call the following command to create it: bin/buzzdesk.CheckSum.pl -a create'
    );
    return 1;
};
