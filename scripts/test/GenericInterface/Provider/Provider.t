...
my $ApacheBaseURL = "$HttpType://$Host/${ScriptAlias}/nph-genericinterface.pl/";
my $PlackBaseURL;
            ...
            )
        {
...

            {
                ...
                if ( $RequestMethod eq 'post' ) {
                    ...
                    $ENV{REQUEST_URI}    = "http://localhost/buzzdesk/nph-genericinterface.pl/$WebserviceAccess";
                    ...
                    # prepare CGI environment variables
                    $ENV{REQUEST_URI}
                        = "http://localhost/buzzdesk/nph-genericinterface.pl/$WebserviceAccess?" . $QueryString;
