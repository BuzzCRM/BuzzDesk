...
#
my $TestUserLogin = $HelperObject->GetRandomID();
...
#
# Check that test user does not exist yet.
#
...
#
%TestUser = $UserObject->GetUserData(
    User => $TestUserLogin,
);
my $TestUserID = $TestUser{UserID};
