...
$Selenium->RunTest(
    sub {
        ...
        # Enable FormDraft in AgentTicketCompose screen.
        $HelperObject->ConfigSettingChange(
            Valid => 1,
            Key   => "Ticket::Frontend::AgentTicketCompose###FormDraft",
            Value => 1,
        );
        ...
        my $Title         = 'ComposeFormDraft' . $RandomID;
        my $FormDraftCase = {
            Module => 'Compose',
            Fields => {
                To => {
                ...
                Body => {
                    ID     => 'RichText',
                    Type   => 'Input',
                    Value  => 'Selenium Compose Body',
                    Update => 'Selenium Compose Body - Update',
                },
                Attachments => {
                    ID   => 'FileUpload',
                    Type => 'Attachment',
