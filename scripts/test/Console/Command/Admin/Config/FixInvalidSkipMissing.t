...
$Self->True(
    (
        $Result
            =~ m{Following settings were not fixed:.*UnitTest::DummyModule::$RandomID.*Please use console command \(bin/buzzdesk\.Console\.pl Admin::Config::Update --help\) or GUI to fix them\.}ms
    ) // 0,
