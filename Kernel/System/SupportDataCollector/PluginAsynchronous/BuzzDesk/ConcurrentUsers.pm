...
package Kernel::System::SupportDataCollector::PluginAsynchronous::BuzzDesk::ConcurrentUsers;
...
sub GetDisplayPath {
    return
        'BuzzDesk@Table:TimeStamp,UserSessionUnique|Unique agents,UserSession|Agent sessions,CustomerSessionUnique|Unique customers,CustomerSession|Customer sessions';
}
...
sub Run {
    ...
    for my $Column (@TableColumns) {
        ...
        $Self->AddResultInformation(
            DisplayPath => Translatable('BuzzDesk') . '/' . Translatable('Concurrent Users'),
