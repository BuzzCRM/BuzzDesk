...
package Kernel::System::SupportDataCollector::Plugin::BuzzDesk::ArticlesPerCommunicationChannel;
...
sub GetDisplayPath {
    return Translatable('BuzzDesk') . '/' . Translatable('Articles Per Communication Channel');
}
