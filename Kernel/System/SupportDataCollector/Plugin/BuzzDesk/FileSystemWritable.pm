...
package Kernel::System::SupportDataCollector::Plugin::BuzzDesk::FileSystemWritable;
...
sub Run {
    ...
    if (@ReadonlyDirectories) {
        $Self->AddResultProblem(
            ...
            Message => Translatable('The file system on your BuzzDesk partition is not writable.'),
        );
    }
    else {
        $Self->AddResultOk(
