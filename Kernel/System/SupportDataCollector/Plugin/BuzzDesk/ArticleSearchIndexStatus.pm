...
package Kernel::System::SupportDataCollector::Plugin::BuzzDesk::ArticleSearchIndexStatus;
...
sub GetDisplayPath {
    return Translatable('BuzzDesk') . '/' . Translatable('Article Search Index Status');
}
