...
package Kernel::System::SupportDataCollector::Plugin::BuzzDesk::CommunicationLogAccountStatus;
...
sub GetDisplayPath {
    return Translatable('BuzzDesk') . '/' . Translatable('Communication Log Account Status (last 24 hours)');
}
