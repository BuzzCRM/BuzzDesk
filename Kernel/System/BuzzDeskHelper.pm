...
package Kernel::System::BuzzDeskHelper;
...
with case sensitive check
    ...
    my $ItemID = $BuzzDeskHelperObject->_ItemReverseListGet($ServiceName, %ServiceListReverse);
...
This function adds a Postmaster X-Header to the list of Postmaster X-Headers to the SysConfig.
    ...
    my $Success = $BuzzDeskHelperObject->_PostmasterXHeaderAdd(
...
This function removes a Postmaster X-Header from the list of Postmaster X-Headers in the SysConfig.
    ...
    my $Success = $BuzzDeskHelperObject->_PostmasterXHeaderRemove(
        Header => 'X-OTRS-OwnHeader'
    );
...
This function adds an Event to the list of Events of an Object to the SysConfig.
    ...
    my $Success = $BuzzDeskHelperObject->_EventAdd(
...
This function removes an Event to the list of Events of an Object to the SysConfig.
    ...
    my $Success = $BuzzDeskHelperObject->_EventRemove(
        Object => 'Ticket', # Ticket, Article, Queue...
        Event  => 'MyCustomEvent'
    );
...
This function returns the DefaultColumn Attributes of the requested SysConfigs.
    ...
    my %Configs = $BuzzDeskHelperObject->_DefaultColumnsGet(@Configs);
...
This function enables the given Attributes for the requested DefaultColumns.
    ...
    my $Success = $BuzzDeskHelperObject->_DefaultColumnsEnable(%Configs);
...
This function disables the given Attributes for the requested DefaultColumns.
    ...
    my $Success = $BuzzDeskHelperObject->_DefaultColumnsDisable(%Configs);
...
Returns the DefaultColumn attributes of the requested SysConfigs, reduced to dynamic fields.
    ...
    my %Configs = $BuzzDeskHelperObject->_DynamicFieldsDefaultColumnsGet(@Configs);
...
This function enables the defined dynamic fields in the needed screens.
    ...
    my $Success = $BuzzDeskHelperObject->_DynamicFieldsScreenEnable(%Screens);
...
This function disables the defined dynamic fields in the needed screens.
    ...
    my $Success = $BuzzDeskHelperObject->_DynamicFieldsScreenDisable(%Screens);
...
This function delete the defined dynamic fields
    ...
    my $Success = $BuzzDeskHelperObject->_DynamicFieldsDelete(@DynamicFields);
...
This function disables the defined dynamic fields
    ...
    my $Success = $BuzzDeskHelperObject->_DynamicFieldsDisable(@DynamicFields);
...
Usable Snippets (SublimeTextAdjustments):
    ...
    my $Result = $BuzzDeskHelperObject->_DynamicFieldsCreateIfNotExists( @DynamicFields );
...
TestDynamicField has the field order 100.
    ...
    my $FieldOrder = $BuzzDeskHelperObject->DynamicFieldFieldOrderAfterFieldGet(
        Name => 'TestDynamicField1',
    );
...
will extended the possible values for the field.
    ...
    my $Success = $BuzzDeskHelperObject->DynamicFieldValueCreate(
...
exports configuration of all dynamic fields
    ...
    my $Configs = $BuzzDeskHelperObject->_DynamicFieldsConfigExport(
...
exports all configured screens of one ore more dynamic fields
    ...
    my $Configs = $BuzzDeskHelperObject->_DynamicFieldsScreenConfigExport(
...
imports all configured screens of one ore more dynamic fields
    ...
    my $Success = $BuzzDeskHelperObject->_DynamicFieldsScreenConfigImport( %Config );
...
creates all postmaster filter that are necessary
    ...
    my $Result = $BuzzDeskHelperObject->_PostMasterFilterCreateIfNotExists( @Filters );
...
exports configuration of all postmaster filter
    ...
    my $Configs = $BuzzDeskHelperObject->_PostMasterFilterConfigExport(
...
imports configuration of postmaster filter via yml
    ...
    my $Success = $BuzzDeskHelperObject->_PostMasterFilterConfigImport(
        Filter => $Filter,
...
creates group if not exists
    ...
    my $Success = $BuzzDeskHelperObject->_GroupCreateIfNotExists(
...
creates role if not exists
    ...
    my $Success = $BuzzDeskHelperObject->_RoleCreateIfNotExists(
        Name => 'Some Role Name',
    );
...
creates Type if not exists
    ...
    my $Success = $BuzzDeskHelperObject->_TypeCreateIfNotExists(
        Name => 'Some Type Name',
    );
...
creates Priority if not exists
    ...
    my $Success = $BuzzDeskHelperObject->_PriorityCreateIfNotExists(
...
creates State if not exists
    ...
    my $Success = $BuzzDeskHelperObject->_StateCreateIfNotExists(
...
disables a given state
    ...
    my $Success = $BuzzDeskHelperObject->_StateDisable(@States);
...
creates state types if not exists
    ...
    my $StateTypeID = $BuzzDeskHelperObject->_StateTypeCreateIfNotExists(
        Name    => 'New StateType',
...
creates Service if not exists
    ...
    my $Success = $BuzzDeskHelperObject->_ServiceCreateIfNotExists(
...
creates SLA if not exists
    ...
    my $Success = $BuzzDeskHelperObject->_SLACreateIfNotExists(
        Name => 'Some ServiceName',
...
creates user if not exists
    ...
    my $UserID = $BuzzDeskHelperObject->_UserCreateIfNotExists(
...
creates CustomerUser if not exists
    ...
    my $CustomerUserLogin = $BuzzDeskHelperObject->_CustomerUserCreateIfNotExists(
...
adds a general catalog item if it does not exist
    ...
    my $ItemID = $BuzzDeskHelperObject->_GeneralCatalogItemCreateIfNotExists(
        Name            => 'Test Item',
...
/opt/buzzdesk/scripts/cmdb_classes/Private_Endgeraete.config

The required general catalog item will be created automatically.

    my $DefinitionID = $BuzzDeskHelperObject->_ITSMConfigItemDefinitionCreate(
...
The required general catalog item will be created automatically.
    ...
    my $DefinitionID = $BuzzDeskHelperObject->_ITSMConfigItemDefinitionCreateIfNotExists(
        Class           => 'Private Endgeraete',
        ClassFile       => 'Private_Endgeraete',  # optional
        PermissionGroup => 'itsm-configitem',     # optional
    );
...
checks if a version already exists without returning a error.
    ...
    my $Found = $BuzzDeskHelperObject->_ITSMConfigItemVersionExists(
        VersionID  => 123,
    );
...
stored in XMLData.
    ...
    my $Success = $BuzzDeskHelperObject->_ParseXML2Data(
...
for xml storage.
    ...
    my $Success = $BuzzDeskHelperObject->_ParseData2XML(
        Parent => $Identifier,          # optional: contains the field name of the parent xml
        Result => $Result,              # contains the reference to the result hash
        Data   => $Data{$Field}->[1],   # contains the xml hash we want to parse
    );
...
creates web services that not exist yet
    ...
    my $Result = $BuzzDeskHelperObject->_WebserviceCreateIfNotExists(
        SubDir => 'BuzzDeskAssetDesk', # optional
    );
...
creates or updates web services
    ...
    # installs all .yml files in $OTRS/scripts/webservices/
    # name of the file will be the name of the webservice
    my $Result = $BuzzDeskHelperObject->_WebserviceCreate(
        SubDir => 'BuzzDeskAssetDesk', # optional
    );
...
deletes web services
    ...
    # name of the file will be the name of the webservice
    my $Result = $BuzzDeskHelperObject->_WebserviceDelete(
        SubDir => 'BuzzDeskAssetDesk', # optional
    );
...
gets a list of .yml files from $OTRS/scripts/webservices
    ...
    my $Result = $BuzzDeskHelperObject->_WebservicesGet(
        SubDir => 'BuzzDeskAssetDesk', # optional
    );

    $Result = {
        'Webservice'          => '$OTRS/scripts/webservices/BuzzDeskAssetDesk/Webservice.yml',
        'New Webservice 1234' => '$OTRS/scripts/webservices/BuzzDeskAssetDesk/New Webservice 1234.yml',
    }
...
Rebuilds OTRS config.
    ...
    my $Success = $BuzzDeskHelperObject->_RebuildConfig();
...
creates processes if there is no active process with the same name
    ...
    my $Success = $BuzzDeskHelperObject->_ProcessCreateIfNotExists(
        SubDir => 'BuzzDeskAssetDesk', # optional
    );
...
creates or updates processes
    ...
    # installs all .yml files in $OTRS/scripts/processes/
    # name of the file will be the name of the process
    my $Success = $BuzzDeskHelperObject->_ProcessCreate(
        SubDir => 'BuzzDeskAssetDesk', # optional
    );
...
gets a list of .yml files from $OTRS/scripts/processes
    ...
    my $Result = $BuzzDeskHelperObject->_ProcessesGet(
        SubDir => 'BuzzDeskAssetDesk', # optional
    );

    $Result = {
        'Process'          => '$OTRS/scripts/processes/BuzzDeskAssetDesk/Process.yml',
        'New Process 1234' => '$OTRS/scripts/processes/BuzzDeskAssetDesk/New Process 1234.yml',
    }
...
gets ProcessWidgetDynamicFieldGroups
    ...
    my %ProcessWidgetDynamicFieldGroups = $BuzzDeskHelperObject->_ProcessWidgetDynamicFieldGroupsGet();
...
gets ProcessWidgetDynamicFieldGroups
    ...
    my $Success = $BuzzDeskHelperObject->_ProcessWidgetDynamicFieldGroupsAdd(
        %ProcessWidgetDynamicFieldGroups
    );
...
gets ProcessWidgetDynamicFieldGroups
    ...
    my $Success = $BuzzDeskHelperObject->_ProcessWidgetDynamicFieldGroupsRemove(
        %ProcessWidgetDynamicFieldGroups
    );
...
This function removes one or more groups from the list of groups of a frontend module registration for any interface.
    ...
    my $Success = $BuzzDeskHelperObject->_ModuleGroupRemove(
        Module => 'Admin',
        Group  => [
            'users',
        ],
...
create or update notification event
    ...
    my $Success = $BuzzDeskHelperObject->_NotificationEventCreate( @NotificationList );
...
creates notification event if not exists
    ...
    my $NotificationID = $BuzzDeskHelperObject->_NotificationEventCreateIfNotExists(
        Name => 'Agent::CustomerVIPPriorityUpdate',
        Data => {
            Events => [
                'TicketPriorityUpdate',
...
create or update standard template
    ...
    my $Success = $BuzzDeskHelperObject->_StandardTemplateCreate( @StandardTemplateList );
...
creates or updates generic agents
    ...
    my @GenericAgents = (
        {
            ...
            Data => {
                ...
                # Add Note
                NewNoteFrom      => 'support@buzzdesk.com',
                NewNoteSubject   => 'BuzzDesk Note Subject',
                NewNoteBody      => 'BuzzDesk Note Text',
    ...
    my $Success = $BuzzDeskHelperObject->_GenericAgentCreate( @GenericAgents );
...
creates generic agents if not exists
    ...
    my $Success = $BuzzDeskHelperObject->_GenericAgentCreateIfNotExists( @GenericAgents );
...
Adds article action menu items.
    ...
    my %ArticleActions = (
        Internal => [ # Channel name (Internal, Phone, Email or Invalid)
            {
                Key      => 'BuzzDeskMarkTicketSeenUnseen',
    ...
    my $Success = $BuzzDeskHelperObject->_ArticleActionsAdd(%ArticleActionMenuItems);
...
sub _ArticleActionsAdd {
    ...
    my $SettingSet = $SysConfigObject->SettingsSet(
        UserID   => 1,
        Comments => 'Article action settings added by BuzzDeskHelper::_ArticleActionsAdd().',
        Settings => \@Settings,
    );
...
Removes article action menu items.
    ...
    my $Success = $BuzzDeskHelperObject->_ArticleActionsRemove(%ArticleActions);
...
sub _ArticleActionsRemove {
    ...
    my $SettingSet = $SysConfigObject->SettingsSet(
        UserID   => 1,
        Comments => 'Article action settings removed by BuzzDeskHelper::_ArticleActionsRemove().',
        Settings => \@Settings,
    );
