...
package Kernel::System::ProcessManagement::TransitionValidation::NotContains;
...
Kernel::System::ProcessManagement::TransitionValidation::NotContains - NotContains for Transition Validation Module

=head1 DESCRIPTION

All NotContains functions.
...
Don't use the constructor directly, use the ObjectManager instead:
    ...
    my $TransitionValidationObject = $Kernel::OM->Get('Kernel::System::ProcessManagement::TransitionValidation::NotContains');
...
sub new {
    ...
    $Self->{Name}  = 'NotContains';
    $Self->{Label} = '( !~ ) not contains';
...
sub Validate {
    ...
    my $Match = $Self->NotContains( $CheckValue, $MatchValue );
