...
sub new {
    ...
    if ( !-w $Self->{DataDir} ) {
        ...
        $Kernel::OM->Get('Kernel::System::Log')->Log(
            Priority => 'notice',
            Message  => "Can't write $Self->{DataDir}! try: \$OTRS_HOME/bin/buzzdesk.SetPermissions.pl!",
        );
        die "Can't write $Self->{DataDir}! try: \$OTRS_HOME/bin/buzzdesk.SetPermissions.pl!";
    }
