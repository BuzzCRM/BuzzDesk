...
sub Data {
    ...
    $Self->{Translation} = {
        ...
        'Install Type' => '',
        'Create a new database for BuzzDesk' => 'Loo OTRSile uus andmebaas',
        'Use an existing database for BuzzDesk' => 'Kasuta olemasolevat andmebaasi',
        ...
        'To be able to use BuzzDesk you have to enter the following line in your command line (Terminal/Shell) as root.' =>
            'BuzzDesk kasutamiseks peate järgneva käsu sisestama süsteemi root-kasutajana.',
        'Restart your webserver' => 'Taaskäivita veebiserver.',
        'After doing so your BuzzDesk is up and running.' => 'Peale seda BuzzDesk töötab.',
        ...
        'BuzzDesk Test Page' => 'BuzzDesk testileht',
        'Unlock' => 'Eemalda lukk',
        'Welcome %s %s' => '',
        'Counter' => 'Loendur',
        ...
        'Install BuzzDesk' => 'Paigalda BuzzDesk',
        'Intro' => 'Sissejuhatus',
