...
sub Data {
    ...
    $Self->{Completeness}        = 0.152488471935125;
    ...
    $Self->{Translation} = {
        ...
        'To be able to use BuzzDesk you have to enter the following line in your command line (Terminal/Shell) as root.' =>
            'Lai varētu izmantot BuzzDesk, sekojošā komanda jāizpilda terminālī/čaulā.',
        'Restart your webserver' => 'Pārstartējiet tīmekļa serveri (webserver).',
        'After doing so your BuzzDesk is up and running.' => 'Pēc tam BuzzDesk būs darba kārtībā un palaists.',
        ...
        'BuzzDesk Test Page' => 'BuzzDesk problēmu pieteikumu sistēmas testa lapa',
        'Unlock' => 'Atslēgt',
        'Welcome %s %s' => '',
        'Counter' => 'Skaitītājs',
        ...
        'Operations' => '',
        'BuzzDesk as requester' => 'BuzzDesk kā pieprasītājs',
        'Invokers' => '',
        ...
        'Install BuzzDesk' => 'Instalējiet BuzzDesk',
        'Intro' => '',
        ...
        'BuzzDesk Disk Partition' => 'BuzzDesk diska nodalījums',

        # Perl Module: Kernel/System/SupportDataCollector/Plugin/OS/DiskSpace.pm
        'Disk Usage' => 'Diska lietojums',
        'The partition where BuzzDesk is located is almost full.' => 'Nodalījums, kurā atrodas BuzzDesk ir gandrīz pilns.',
        'The partition where BuzzDesk is located has no disk space problems.' =>
            'Nodalījums, kurā atrodas BuzzDesk nav diska vietas problēmas.',
        ...
        'BuzzDesk Version' => 'BuzzDesk versija',
