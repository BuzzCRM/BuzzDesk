...
sub Data {
    ...
    $Self->{Translation} = {
        ...
        'After doing so your BuzzDesk is up and running.' => 'Bunu yaptıktan sonra BuzzDesk çalışıyor olacak.',
        ...
        'BuzzDesk Test Page' => 'BuzzDesk Test Sayfası',
        'Unlock' => 'Kilidi Aç',
        'Welcome %s %s' => '',
        'Counter' => 'Sayaç',
