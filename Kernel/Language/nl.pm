...
sub Data {
    ...
    $Self->{Translation} = {
        ...
        'This BuzzDesk invoker backend module will be called to prepare the data to be sent to the remote system, and to process its response data.' =>
            'Deze BuzzDesk invoker module zal worden aangeroepen om de data te formatteren voordat deze naar het andere systeem verstuurd wordt.',
        ...
        'The data from the invoker of BuzzDesk will be processed by this mapping, to transform it to the kind of data the remote system expects.' =>
            'De data van de invoker van BuzzDesk wordt verwerkt door deze mapping om het om te zetten in het formaat wat het communicerende systeem verwacht.',
        ...
        'The response data will be processed by this mapping, to transform it to the kind of data the invoker of BuzzDesk expects.' =>
            'De data van het antwoord wordt verwerkt door deze koppeling om dit om te zetten in het formaat wat de BuzzDesk invoker verwacht.',
        ...
        'Asynchronous event triggers are handled by the BuzzDesk Scheduler Daemon in background (recommended).' =>
            'Asynchrone event-triggers worden in de achtergrond afgehandeld door de BuzzDesk Scheduler Daemon (aangeraden).',
        ...
        'This BuzzDesk operation backend module will be called internally to process the request, generating data for the response.' =>
            'Deze BuzzDesk operatie-module zal intern worden gebruikt om de data voor de respons te genereren.',
        ...
        'The request data will be processed by this mapping, to transform it to the kind of data BuzzDesk expects.' =>
            'De inkomende data wordt verwerkt door deze koppeling, om het om te zetten naar de data die BuzzDesk verwacht.',
        ...
        'Here you can specify the maximum size (in bytes) of REST messages that BuzzDesk will process.' =>
            'Hier kun je het maximum aantal bytes bepalen van REST berichten die BuzzDesk verwerkt.',
        ...
        'The full path and name of the SSL client certificate file (must be in PEM, DER or PKCS#12 format).' =>
            '',
        'e.g. /opt/buzzdesk/var/certificates/SOAP/certificate.pem' => 'bv. /opt/buzzdesk/var/certificates/SOAP/certificate.pem',
        'Client Certificate Key' => 'Client Certificaatsleutel',
        'The full path and name of the SSL client certificate key file (if not already included in certificate file).' =>
            '',
        'e.g. /opt/buzzdesk/var/certificates/SOAP/key.pem' => 'bv. /opt/buzzdesk/var/certificates/SOAP/key.pem',
        ...
        'e.g. /opt/buzzdesk/var/certificates/SOAP/CA/ca.pem' => 'Bijvoorbeeld /opt/buzzdesk/var/certificates/SOAP/CA/ca.pem',
        ...
        'e.g. /opt/buzzdesk/var/certificates/SOAP/CA' => 'bijvoorbeeld /opt/buzzdesk/var/certificates/SOAP/CA',
        ...
        'Here you can specify the maximum size (in bytes) of SOAP messages that BuzzDesk will process.' =>
            'Hier kunt u de maximale berichtgrootte (in bytes) opgeven van de berichten die BuzzDesk zal verwerken.',
        ...
        'In provider mode, BuzzDesk offers web services which are used by remote systems.' =>
            'In Provider-modus levert BuzzDesk web services die aangeroepen worden door andere systemen.',
        'In requester mode, BuzzDesk uses web services of remote systems.' =>
            'In Requester-modus gebruikt BuzzDesk web services van andere systemen.',
        'Network transport' => 'Netwerk-transport',
        ...
        'Clear log entries' => '',
        'Here you will find log information about your system.' => 'Hier is de BuzzDesk log te raadplegen.',
        ...
        'In this way you can directly edit the certification and private keys in file system.' =>
            'Hier kunt u de certificaten en private sleutels van BuzzDesk beheren.',
        ...
        'The BuzzDesk Daemon is a daemon process that performs asynchronous tasks, e.g. ticket escalation triggering, email sending, etc.' =>
            'De BuzzDesk Daemon is een achtergrondproces dat a synchrone taken uitvoert, dat wil zeggen, escalatie van tickets, gebeurtenissen, emails en dergelijke.',
        'A running BuzzDesk Daemon is mandatory for correct system operation.' =>
            'Een draaiende BuzzDesk Daemon is vereist voor een correcte werking van het systeem.',
        'Starting the BuzzDesk Daemon' => 'De BuzzDesk Daemon wordt opgestart',
        'Make sure that the file \'%s\' exists (without .dist extension). This cron job will check every 5 minutes if the BuzzDesk Daemon is running and start it if needed.' =>
            'Zorg er voor dat het bestand \'%s\' bestaat (zonder .dist extensie). Deze cron taak controleert elke 5 minuten of de BuzzDesk Daemon loopt en start hem als het nodig is.',
        'Execute \'%s start\' to make sure the cron jobs of the \'buzzdesk\' user are active.' =>
            'Voer \'%s start\' uit om ervoor te zorgen dat de cron jobs van de gebruiker \'buzzdesk\' actief zijn.',
        'After 5 minutes, check that the BuzzDesk Daemon is running in the system (\'bin/buzzdesk.Daemon.pl status\').' =>
            'Controleer na 5 minuten of de BuzzDesk Daemon draait in het systeem (\'bin/buzzdesk.Daemon.pl status\').',
        ...
        'Create a new database for BuzzDesk' => 'Maak een nieuwe database voor BuzzDesk aan',
        'Use an existing database for BuzzDesk' => 'Gebruik een bestaande database voor BuzzDesk',
        ...
        'A new database user with limited permissions will be created for this BuzzDesk system.' =>
            'Een nieuwe database gebruiker met beperkte permissies wordt aangemaakt voor deze BuzzDesk omgeving.',
        ...
        'To be able to use BuzzDesk you have to enter the following line in your command line (Terminal/Shell) as root.' =>
            'Om BuzzDesk te gebruiken moet u nu de webserver herstarten.',
        'Restart your webserver' => 'Herstart webserver',
        'After doing so your BuzzDesk is up and running.' => 'Hierna is BuzzDesk klaar voor gebruik.',
        ...
        'Sorry, but this feature of BuzzDesk is currently not available for mobile devices. If you\'d like to use it, you can either switch to desktop mode or use your regular desktop device.' =>
            'Helaas, maar deze functionaliteit van BuzzDesk is op dit moment niet beschikbaar voor mobiele apparaten. Als je de functionaliteit toch wil gebruiken kun je swichen naar desktop weergave of je desktop device gebruiken.',
        ...
        'BuzzDesk Test Page' => 'BuzzDesk Testpagina',
        'Unlock' => 'Ontgrendel',
        ...
        'Mr.' => 'Dhr.',
        'Mrs.' => 'Mevr.',
        'View system log messages.' => 'Bekijk het BuzzDesk logboek.',
        ...
        'ACLs could not be Imported due to a unknown error, please check BuzzDesk logs for more information' =>
            'ACL\'s kunnen niet worden geïmporteerd vanwege een onbekende fout, kijk in de BuzzDesk loggegevens voor meer informatie.',
        ...
        'System Configuration could not be imported due to an unknown error, please check BuzzDesk logs for more information.' =>
            'Systeemconfiguratie kon niet worden geïmporteerd vanwege een onbekende fout. Raadpleeg de BuzzDesk-logboeken voor meer informatie.',
        ...
        'Some imported settings are not present in the current state of the configuration or it was not possible to update them. Please check the BuzzDesk log for more information.' =>
            'Sommige geïmporteerde instellingen zijn niet aanwezig in de huidige  configuratie of het was niet mogelijk om deze bij te werken. Raadpleeg het BuzzDesk-logboek voor meer informatie.',
        ...
        'Install BuzzDesk' => 'Installeer BuzzDesk',
        'Intro' => 'Introductie',
        ...
        'BuzzDesk Daemon is not running.' => 'BuzzDesk Daemon is niet actief.',
        ...
        'BuzzDesk Disk Partition' => 'BuzzDesk Schijfpartitie',

        # Perl Module: Kernel/System/SupportDataCollector/Plugin/OS/DiskSpace.pm
        'Disk Usage' => 'Harde schijf gebruik',
        'The partition where BuzzDesk is located is almost full.' => 'De partitie waar BuzzDesk op staat is bijna vol.',
        'The partition where BuzzDesk is located has no disk space problems.' =>
            'De partitie waar BuzzDesk op staat heeft voldoende ruimte.',
        ...
        'BuzzDesk requires apache to be run with the \'prefork\' MPM model.' =>
            'BuzzDesk vereist dat apache wordt uitgevoerd met de \'prefork\' MPM model.',
        ...
        'The file system on your BuzzDesk partition is not writable.' => 'Het bestandsysteem op de BuzzDesk partitie is niet schrijfbaar.',
        ...
        'Table ticket_lock_index contains orphaned records. Please run bin/buzzdesk.Console.pl "Maint::Ticket::QueueIndexCleanup" to clean the StaticDB index.' =>
            'De tabel ticket_lock_index bevat weesreckords. Om sw StaticDB te schonen voert u het volgende script: uit bin/buzzdesk.Console.pl "Maint::Ticket::QueueIndexCleanup".',
        ...
        'BuzzDesk Version' => 'BuzzDesk-versie',
        ...
        'Adds a suffix with the actual year and month to the BuzzDesk log file. A logfile for every month will be created.' =>
            'Voegt een achtervoegsel met het eigenlijke jaar en maand toe aan het BuzzDesk logbestand. Er wordt een logbestand gemaakt voor elke maand.',
        ...
        'WARNING: When you change the name of the group \'admin\', before making the appropriate changes in the SysConfig, you will be locked out of the administrations panel! If this happens, please rename the group back to admin per SQL statement.' =>
            'WAARSCHUWING: Als u de naam van de groep \'admin\'aanpast voordat u de bijbehorende wijzigingen in de Systeemconfiguratie heeft aangebracht, zult u geen beheer-permissies meer hebben in BuzzDesk. Als dit gebeurt, moet u de naam van de groep aanpassen met een SQL statement.',
        ...
        'Information about the BuzzDesk Daemon' => 'Informatie over de BuzzDesk Daemon',
