...
sub Data {
    ...
    $Self->{Translation} = {
        ...
        'A running BuzzDesk Daemon is mandatory for correct system operation.' =>
            'Um Daemon BuzzDesk em funcionamento é obrigatório para o funcionamento correto do sistema.',
        ...
        'A new database user with limited permissions will be created for this BuzzDesk system.' =>
            'Vai ser criado um novo utilizador de base de dados com permissões limitadas para o BuzzDesk',
        'Repeat Password' => '',
        'Generated password' => '',
        ...
        'To be able to use BuzzDesk you have to enter the following line in your command line (Terminal/Shell) as root.' =>
            'Para usar o BuzzDesk tem de executar o seguinte comando na consola, (Terminal/Shell) como root.',
        'Restart your webserver' => 'Reinicie o servidor Web',
        'After doing so your BuzzDesk is up and running.' => 'Depois de o fazer, o BuzzDesk estará funcional.',
        ...
        'BuzzDesk Test Page' => 'Página de Teste do BuzzDesk',
        'Unlock' => 'Desbloquear',
        'Welcome %s %s' => '',
        'Counter' => 'Contador',
        ...
        'BuzzDesk as provider' => 'BuzzDesk como prestador',
        ...
        'BuzzDesk Daemon is not running.' => 'O Daemon BuzzDesk não está em execução.',
        ...
        'Adds a suffix with the actual year and month to the BuzzDesk log file. A logfile for every month will be created.' =>
            'Adiciona um sufixo com o ano e mês atual ao ficheiro de log do BuzzDesk. Vai ser criado um ficheiro mensal.',
