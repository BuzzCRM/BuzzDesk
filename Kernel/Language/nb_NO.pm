...
sub Data {
    ...
    $Self->{Translation} = {
        ...
        'The full path and name of the certification authority certificate file that validates SSL certificate.' =>
            '',
        'e.g. /opt/buzzdesk/var/certificates/SOAP/CA/ca.pem' => 'f.eks. /opt/buzzdesk/var/certificates/SOAP/CA/ca.pem',
        'Certification Authority (CA) Directory' => '',
        'The full path of the certification authority directory where the CA certificates are stored in the file system.' =>
            '',
        'e.g. /opt/buzzdesk/var/certificates/SOAP/CA' => '',
        ...
        'To be able to use PGP in BuzzDesk, you have to enable it first.' =>
            'For å kunne bruke PGP funksjonen i BuzzDesk må du først aktivere den.',
        ...
        'Go to buzzdesk.org' => 'Gå til buzzdesk.org',
        'package information' => '',
        ...
        'A running BuzzDesk Daemon is mandatory for correct system operation.' =>
            'En kjørende BuzzDesk agent er påkrevd for at systemet skal kjøre riktig.',
        'Starting the BuzzDesk Daemon' => 'Innstillinger for BuzzDesk Agenten',
        ...
        'A new database user with limited permissions will be created for this BuzzDesk system.' =>
            'En ny databasebruker med begrensede rettigheter vil bli opprettet for denne BuzzDesk-installasjonen.',
        ...
        'To be able to use BuzzDesk you have to enter the following line in your command line (Terminal/Shell) as root.' =>
            'For å kunne bruke BuzzDesk, må følgende linje utføres på kommandolinjen som root.',
        'Restart your webserver' => 'Restart webserveren din',
        'After doing so your BuzzDesk is up and running.' => 'Etter dette vil BuzzDesk være oppe og kjøre.',
        ...
        'BuzzDesk Test Page' => 'BuzzDesk Test-side',
        'Unlock' => 'Frigi sak',
        ...
        'BuzzDesk as provider' => 'BuzzDesk som en leverandør',
        'Operations' => 'Handlinger',
        'BuzzDesk as requester' => 'BuzzDesk som en etterspørrer',
        'Invokers' => '',
        ...
        'BuzzDesk Daemon is not running.' => 'BuzzDesk tjenesten kjører ikke',
        ...
        'BuzzDesk Disk Partition' => 'BuzzDesk diskpartisjon',

        # Perl Module: Kernel/System/SupportDataCollector/Plugin/OS/DiskSpace.pm
        'Disk Usage' => 'Diskforbruk',
        'The partition where BuzzDesk is located is almost full.' => 'Partisjonen hvor BuzzDesk er plassert, er nesten full.',
        'The partition where BuzzDesk is located has no disk space problems.' =>
            'Partisjonen hvor BuzzDesk er plasser, har igjen diskplass problemer.',
        ...
        'BuzzDesk requires apache to be run with the \'prefork\' MPM model.' =>
            'BuzzDesk krever Apache for å kunne kjøre \'prefork\' MPM modellen.',
        ...
        'The file system on your BuzzDesk partition is not writable.' => 'Filsystemet for din BuzzDesk partisjon er ikke mulig å skrive til.',
        ...
        'BuzzDesk Version' => 'BuzzDesk versjon',
        ...
        'Defines a filter for html output to add links behind CVE numbers. The element Image allows two input kinds. At once the name of an image (e.g. faq.png). In this case the BuzzDesk image path will be used. The second possiblity is to insert the link to the image.' =>
            'Definerer et filter for HTML-visning for å legge til lenker bak CVE-nummer. Bilde-elementet tillater to typer inn-data. Enten navnet på en bilde-fil (f.eks. bilde01.png), der BuzzDesk vil gå utfra at bildet ligger i BuzzDesk sin bildemappe. Eller man kan oppgi URL til et bilde.',
        'Defines a filter for html output to add links behind bugtraq numbers. The element Image allows two input kinds. At once the name of an image (e.g. faq.png). In this case the BuzzDesk image path will be used. The second possiblity is to insert the link to the image.' =>
            'Definerer et filter for HTML-visning som legger til lenker bak BugTraq-numre. Bilde-elementet tillater to typer inn-data. Enten navnet på en bildefil (f.eks. bilde01.png), der BuzzDesk vil gå utfra at bildet ligger i BuzzDesk sin bildemappe. Eller man kan oppgi URL til et bilde.',
        'Defines a filter for html output to add links behind MSBulletin numbers. The element Image allows two input kinds. At once the name of an image (e.g. faq.png). In this case the BuzzDesk image path will be used. The second possiblity is to insert the link to the image.' =>
            'Definerer et filter i HTML-visningen for å legge til lenker bak MSBulletin-nummer. Bildeelementet tillater to typer inn-data. Enten navnet på en bilde-fil (f.eks. bilde01.png), der BuzzDesk vil gå utfra at bildet ligger i BuzzDesk sin bildemappe. Eller man kan oppgi URL til et bilde.',
        'Define a filter for html output to add links behind a defined string. The element Image allows two input kinds. At once the name of an image (e.g. faq.png). In this case the BuzzDesk image path will be used. The second possiblity is to insert the link to the image.' =>
            'Sett et filter for HTML-visning som legger til lenker bak en gitt tekst. Bildeelementet tillater to typer inn-data. For det første navnet på et bilde (f.eks. bilde01.png). I det tilfellet vil BuzzDesk sin bilde-sti brukes. Den andre muligheten er å skrive inn URL til bildet',
        'Defines a filter for html output to add links behind a defined string. The element Image allows two input kinds. At once the name of an image (e.g. faq.png). In this case the BuzzDesk image path will be used. The second possiblity is to insert the link to the image.' =>
            'Definerer et filter for HTML-visning som legger til lenker bak en definert tekst. Bilde-elementet tillater to typer inn-data. Enten navnet på en bilde-fil (f.eks. bilde01.png), der BuzzDesk vil gå utfra at bildet ligger i BuzzDesk sin bildemappe. Eller man kan oppgi URL til et bilde.',
        ...
        'If enabled, BuzzDesk will deliver all JavaScript files in minified form.' =>
            'Hvis slått på vil BuzzDesk levere alle JavaScript-filer i minimert form',
        ...
        'Information about the BuzzDesk Daemon' => 'Informasjon om BuzzDesk Agenten',
