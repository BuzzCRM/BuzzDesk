...
sub Data {
    ...
    $Self->{Completeness}        = 0.191763396406424;
    ...
    $Self->{Translation} = {
        ...
        'This BuzzDesk invoker backend module will be called to prepare the data to be sent to the remote system, and to process its response data.' =>
            'Този модул за обратна връзка на BuzzDesk заявки ще бъде извикан, за да подготви данните, които да бъдат изпратени до отдалечената система, и да обработва данните за отговори.',
        ...
        'The data from the invoker of BuzzDesk will be processed by this mapping, to transform it to the kind of data the remote system expects.' =>
            'Данните от заявката на BuzzDesk ще бъдат обработени от това картографиране, за да се превърнат в вид данни, които отдалечената система очаква.',
        ...
        'The response data will be processed by this mapping, to transform it to the kind of data the invoker of BuzzDesk expects.' =>
            'Данните за отговорите ще бъдат обработени от това картографиране, за да бъдат преработени в типа данни, които заявката на BuzzDesk очаква.',
        ...
        'Asynchronous event triggers are handled by the BuzzDesk Scheduler Daemon in background (recommended).' =>
            'Асинхронните събития се обработват от BuzzDesk Scheduler Daemon на заден план (препоръчително).',
        ...
        'This BuzzDesk operation backend module will be called internally to process the request, generating data for the response.' =>
            'Този модул за обратна връзка за операцията BuzzDesk ще бъде наречена вътрешно, за да обработи заявката, генерирайки данни за отговора.',
        ...
        'The request data will be processed by this mapping, to transform it to the kind of data BuzzDesk expects.' =>
            'Данните за заявката ще бъдат обработени от това картографиране, за да се предоставят в вида данни, който BuzzDesk очаква.',
        ...
        'Here you can specify the maximum size (in bytes) of REST messages that BuzzDesk will process.' =>
            'Тук можете да зададете максималния размер (в байтове) на съобщенията, които BuzzDesk ще обработва.',
        ...
        'Here you can specify the maximum size (in bytes) of SOAP messages that BuzzDesk will process.' =>
            'Тук можете да посочите максималния размер (в байтове) на SOAP съобщения, които BuzzDesk ще обработва.',
        ...
        'In provider mode, BuzzDesk offers web services which are used by remote systems.' =>
            'В модула за доставчици BuzzDesk предлага уеб услуги, които се използват от отдалечени системи.',
        'In requester mode, BuzzDesk uses web services of remote systems.' =>
            'В режим "рикуестър" BuzzDesk използва уеб услуги на отдалечени системи.',
        ...
        'To be able to use BuzzDesk you have to enter the following line in your command line (Terminal/Shell) as root.' =>
            'За да може да използвате BuzzDesk, Вие трябва да въведете, като superuser root в командния ред (Terminal/Shell) следната команда',
        'Restart your webserver' => 'Рестарт на web сървъра',
        'After doing so your BuzzDesk is up and running.' => 'След извършването на това, Вашият BuzzDesk е напълно работоспособен.',
        ...
        'BuzzDesk Test Page' => 'Тестова страница на BuzzDesk',
        'Unlock' => 'Отключи',
        'Welcome %s %s' => '',
        'Counter' => 'Брояч',
        ...
        'BuzzDesk as provider' => 'BuzzDesk като доставчик',
        'Operations' => '',
        'BuzzDesk as requester' => 'BuzzDesk като рикуестър',
        'Invokers' => '',
        ...
        'Install BuzzDesk' => 'Инсталирай BuzzDesk',
        'Intro' => 'Въведение',
        ...
        'BuzzDesk Daemon is not running.' => 'BuzzDesk Daemon не се изпълнява.',
