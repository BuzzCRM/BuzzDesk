...
sub Data {
    ...
    $Self->{Completeness}        = 0.200508824932422;
    ...
    $Self->{Translation} = {
        ...
        'This BuzzDesk invoker backend module will be called to prepare the data to be sent to the remote system, and to process its response data.' =>
            'Aquest mòdul del motor de l\'invocador de BuzzDesk es dirà per preparar les dades per ser enviats al sistema remot, i per processar les seves dades de resposta.',
        ...
        'The data from the invoker of BuzzDesk will be processed by this mapping, to transform it to the kind of data the remote system expects.' =>
            'Les dades de l\'invocador de BuzzDesk seran processats ​​per aquesta assignació, per transformar-la en el tipus de dades que el sistema remot espera.',
        ...
        'The response data will be processed by this mapping, to transform it to the kind of data the invoker of BuzzDesk expects.' =>
            'Les dades de resposta seran processats per aquesta assignació, per transformar-los en el tipus de dades que l\'invocador de BuzzDesk espera.',
        ...
        'A new database user with limited permissions will be created for this BuzzDesk system.' =>
            'Un nou usuari de base de dades amb drets limitats serà creat per a aquest sistema BuzzDesk.',
        'Repeat Password' => '',
        'Generated password' => '',
        ...
        'To be able to use BuzzDesk you have to enter the following line in your command line (Terminal/Shell) as root.' =>
            'Per a poder utilitzar BuzzDesk ha d\'escriure la següent linea de comandos (Terminal/Shell) com root',
        'Restart your webserver' => 'Reiniciï el seu servidor web',
        'After doing so your BuzzDesk is up and running.' => 'Després de fer això el seu BuzzDesk estarà actiu i executant-se',
        ...
        'BuzzDesk Test Page' => 'Pàgina de prova de BuzzDesk ',
        'Unlock' => 'Desbloquejar',
        'Welcome %s %s' => '',
        'Counter' => 'Comptador',
        ...
        'Install BuzzDesk' => 'Instal·lar BuzzDesk',
        'Intro' => 'Intro',
        ...
        'Adds a suffix with the actual year and month to the BuzzDesk log file. A logfile for every month will be created.' =>
            'Afegeix un sufix amb l\'any actual i el mes en el fitxer de registre de BuzzDesk. Es crearà un arxiu per cada mes.',
