...
sub Data {
    ...
    $Self->{Completeness}        = 0.147241214819526;
    ...
    $Self->{Translation} = {
        ...
        'To be able to use BuzzDesk you have to enter the following line in your command line (Terminal/Shell) as root.' =>
            'Để có thể sử dụng BuzzDesk bạn phải nhập dòng sau vào dòng lệnh của bạn (Terminal/Shell) làm gốc.',
        'Restart your webserver' => 'Khởi động lại máy chủ web.',
        'After doing so your BuzzDesk is up and running.' => 'Sau khi thực hiện BuzzDesk của bạn đã hoạt động.',
        ...
        'BuzzDesk Test Page' => 'Trang test BuzzDesk',
        'Unlock' => 'Mở khóa',
        'Welcome %s %s' => '',
        'Counter' => 'Bộ đếm',
        ...
        'BuzzDesk as provider' => 'BuzzDesk là nhà cung cấp ',
        'Operations' => '',
        'BuzzDesk as requester' => 'BuzzDesk như yêu cầu',
        'Invokers' => '',
        ...
        'Install BuzzDesk' => 'Cài đặt BuzzDesk',
        'Intro' => 'Giới thiệu',
