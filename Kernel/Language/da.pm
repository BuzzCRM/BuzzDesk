...
sub Data {
    ...
    $Self->{Completeness}        = 0.335665447606933;
    ...
    $Self->{Translation} = {
        ...
        'Here you can specify the maximum size (in bytes) of REST messages that BuzzDesk will process.' =>
            'Her kan du angive den maksimale længde (i bytes) af REST-beskeder, som BuzzDesk vil behandle.',
        ...
        'e.g. /opt/buzzdesk/var/certificates/SOAP/CA' => 'f.eks. /opt/buzzdesk/var/certificates/SOAP/CA',
        ...
        'The BuzzDesk Daemon is a daemon process that performs asynchronous tasks, e.g. ticket escalation triggering, email sending, etc.' =>
            'BuzzDesk tjenesten er en tjeneste der udfører asynkrone opgaver, f.eks. sags eskalering, afsendelse af email, osv.',
        'A running BuzzDesk Daemon is mandatory for correct system operation.' =>
            'En kørende BuzzDesk tjeneste er påkrævet for korrekt system operation.',
        'Starting the BuzzDesk Daemon' => 'Starter BuzzDesk tjeneste',
        'Make sure that the file \'%s\' exists (without .dist extension). This cron job will check every 5 minutes if the BuzzDesk Daemon is running and start it if needed.' =>
            'Kontroller at filen \'%s\' eksisterer (uden .dist filendelsen). Dette cron job  checker hvert 5. minut om BuzzDesk tjenesten kører og starter den om nødvendigt.',
        'Execute \'%s start\' to make sure the cron jobs of the \'buzzdesk\' user are active.' =>
            'Kør \'%s start\' for at sikre at \'buzzdesk\' brugerens cron job er aktive.',
        'After 5 minutes, check that the BuzzDesk Daemon is running in the system (\'bin/buzzdesk.Daemon.pl status\').' =>
            'Check at BuzzDesk tjenesten kører efter 5 minutter (\'bin/buzzdesk.Daemon.pl status\').',
        ...
        'Create a new database for BuzzDesk' => 'Opret ny database til BuzzDesk',
        'Use an existing database for BuzzDesk' => 'Brug en eksisterende database til BuzzDesk',
        ...
        'A new database user with limited permissions will be created for this BuzzDesk system.' =>
            'En ny database-bruger med begrænsede rettigheder vil blive oprettet til dette BuzzDesk-system.',
        ...
        'To be able to use BuzzDesk you have to enter the following line in your command line (Terminal/Shell) as root.' =>
            'For at kunne anvende BuzzDesk, er du nødt til at indtaste følgende linje i din kommandolinje (Terminal/Shell) som root.',
        'Restart your webserver' => 'Genstart webserveren',
        'After doing so your BuzzDesk is up and running.' => 'Når det er gjort, er din BuzzDesk sat i gang og fungerer.',
        ...
        'Sorry, but this feature of BuzzDesk is currently not available for mobile devices. If you\'d like to use it, you can either switch to desktop mode or use your regular desktop device.' =>
            'Beklager, men denne funktion i BuzzDesk er ikke tilgængelig for mobile enheder. Hvis du gerne vil bruge den, kan du enten skifte til desktop-visning eller bruge din almindelige desktop-pc.',
        ...
        'BuzzDesk Test Page' => 'BuzzDesk prøveside',
        'Unlock' => 'Frigiv',
        ...
        'BuzzDesk as provider' => 'BuzzDesk som provider',
        'Operations' => '',
        'BuzzDesk as requester' => 'BuzzDesk som requester',
        'Invokers' => '',
        ...
        'BuzzDesk Daemon is not running.' => 'BuzzDesk-dæmonen kører ikke.',
        ...
        'BuzzDesk Disk Partition' => 'BuzzDesk Disk Partition',

        # Perl Module: Kernel/System/SupportDataCollector/Plugin/OS/DiskSpace.pm
        'Disk Usage' => 'Diskforbrug',
        'The partition where BuzzDesk is located is almost full.' => 'Den partition BuzzDesk befinder sig på er næsten fuld.',
        'The partition where BuzzDesk is located has no disk space problems.' =>
            'Den partition BuzzDesk befinder sig på har ingen pladsproblemer.',
        ...
        'BuzzDesk requires apache to be run with the \'prefork\' MPM model.' =>
            'BuzzDesk kræver, at apache kører med MPM-modellen \'prefork\'.',
        ...
        'The file system on your BuzzDesk partition is not writable.' => 'Filsystemet på din BuzzDesk-partition er ikke skrivbart.',
        ...
        'If "LDAP" was selected for Customer::Authmodule, you can check if the user is allowed to authenticate because he is in a posixGroup, e.g. user needs to be in a group xyz to use BuzzDesk. Specify the group, who may access the system.' =>
            'Hvis "LDAP" er valgt for Customer::Authmodule kan du bestemme om en bruger må logge ind ved at gøre dem til medlem af en possixGroup, f.eks. brugeren skal være medlem af gruppe xyz for at benytte BuzzDesk. Angiv gruppen der skal have adgang til systemet.',
        ...
        'Information about the BuzzDesk Daemon' => 'Information om BuzzDesk tjenesten',
