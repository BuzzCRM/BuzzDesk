...
sub Data {
    ...
    $Self->{Translation} = {
        ...
        'To be able to use BuzzDesk you have to enter the following line in your command line (Terminal/Shell) as root.' =>
            'Aby ste mohli pouzivat BuzzDesk =>  musite zadat nasledovne: do Vasho prikazoveho riadku (terminal/shell) =>  pricom musite byt prihlaseny ako root:',
        'Restart your webserver' => 'dat "nasledovne") do Vasho prikazoveho riadku (terminal/shell) =>  pricom musite byt prihlaseny ako root:',
        'After doing so your BuzzDesk is up and running.' => 'Ak to urobíte =>  Váš BuzzDesk je spustený.',
        ...
        'BuzzDesk Test Page' => 'BuzzDesk test stránka',
        'Unlock' => 'Odomknúť',
        ...
        'BuzzDesk as provider' => 'BuzzDesk ako provider',
        'Operations' => '',
        'BuzzDesk as requester' => 'BuzzDesk ako žiadateľ',
        'Invokers' => '',
        ...
        'Install BuzzDesk' => 'Inštalácia BuzzDesk',
        'Intro' => 'Úvod',
        ...
        'BuzzDesk Daemon is not running.' => 'BuzzDesk démon nebeží.',
