...
sub Data {
    ...
    $Self->{Completeness}        = 0.267610112895532;
    ...
    $Self->{Translation} = {
        ...
        'This BuzzDesk invoker backend module will be called to prepare the data to be sent to the remote system, and to process its response data.' =>
            'Овој BuzzDesk позадински повикувачки модул ќе биде повикан за да подготви податоци за испраќање на одалечен систем, и да ги испроцесира податочен одговор.',
        ...
        'The data from the invoker of BuzzDesk will be processed by this mapping, to transform it to the kind of data the remote system expects.' =>
            'Податоците од повикувач на BuzzDesk ќе бидат обработени со оваа мапирање, за да го трансформира во вид на податоци на системот за далечинско очекува.',
        ...
        'The response data will be processed by this mapping, to transform it to the kind of data the invoker of BuzzDesk expects.' =>
            'Податоците за одговор ќе бидат обработени со оваа мапирање, за да го трансформира во вид на податоци на повикувач на очекувања на BuzzDesk.',
        ...
        'This BuzzDesk operation backend module will be called internally to process the request, generating data for the response.' =>
            'Овој BuzzDesk позадински операциски модул ќе биде повикан интерно за да го испроцесира барањето , генерирајки податоци за одговорот.',
        ...
        'The request data will be processed by this mapping, to transform it to the kind of data BuzzDesk expects.' =>
            'Побараните податоци ќе бидат процесирани со оваа мапирање , за да се трансформираат во вид на податочна форма која BuzzDesk ја очекува.',
        ...
        'Here you can specify the maximum size (in bytes) of REST messages that BuzzDesk will process.' =>
            'Тука може да наведете максималната големина (во бајти) на REST пораки кои BuzzDesk ќе ги обработува.',
        ...
        'e.g. /opt/buzzdesk/var/certificates/SOAP/CA/ca.pem' => 'п.р. /opt/buzzdesk/var/certificates/SOAP/CA/ca.pem',
        ...
        'e.g. /opt/buzzdesk/var/certificates/SOAP/CA' => 'на пример: /opt/buzzdesk/var/certificates/SOAP/CA',
        ...
        'Here you can specify the maximum size (in bytes) of SOAP messages that BuzzDesk will process.' =>
            'Тука може да наведете максималната големина (во бајти) на SOAP пораките кои BuzzDesk ќе ги процесира.',
        ...
        'In provider mode, BuzzDesk offers web services which are used by remote systems.' =>
            'Во режимот на провајдерот, BuzzDesk нуди веб услуги кои се користат од страна на далечински системи.',
        'In requester mode, BuzzDesk uses web services of remote systems.' =>
            'Во побарувачки мод, BuzzDesk користи веб сервиси од далечински системи.',
        ...
        'After doing so your BuzzDesk is up and running.' => '',
        'Start page' => '',
        ...
        'BuzzDesk as provider' => 'BuzzDesk како давател',
        'Operations' => '',
        'BuzzDesk as requester' => 'OТRS како барател',
        'Invokers' => '',
        ...
        'BuzzDesk Disk Partition' => 'BuzzDesk диск партиција',

        # Perl Module: Kernel/System/SupportDataCollector/Plugin/OS/DiskSpace.pm
        'Disk Usage' => 'Користење на Диск ',
        'The partition where BuzzDesk is located is almost full.' => 'Партицијата каде што се наоѓа BuzzDesk е речиси полна.',
        ...
        'The file system on your BuzzDesk partition is not writable.' => 'На датотечниот систем на вашиот BuzzDesk партиција не може да се запишува.',
