...
sub Data {
    ...
    $Self->{Translation} = {
        ...
        'To be able to use BuzzDesk you have to enter the following line in your command line (Terminal/Shell) as root.' =>
            'Voidaksesi käyttää BuzzDesk-järjestelmää tulee sinun kirjoittaa seuraava komento root oikeuksilla komentokehotteessa.',
        'Restart your webserver' => 'Käynnistä web-palvelin uudestaan',
        'After doing so your BuzzDesk is up and running.' => 'Tämän jälkeen BuzzDesk järjestelmä on käytettävissä.',
        ...
        'BuzzDesk Test Page' => 'BuzzDesk - Testisivu',
        ...
        'BuzzDesk as provider' => 'BuzzDesk antaa tietoja',
        'Operations' => '',
        'BuzzDesk as requester' => 'BuzzDesk pyytää tietoja',
        'Invokers' => '',
        ...
        'Install BuzzDesk' => 'Asenna BuzzDesk',
        'Intro' => 'Intro',
