...
הקבצים צריכים להיות בפורמט yml. אשר ייצאו דרך מודול  ACL editor.',
        ...
        'After doing so your BuzzDesk is up and running.' => 'לאחר שמערכת BuzzDesk תותקן.',
        ...
        'BuzzDesk Test Page' => 'עמוד בדיקה BuzzDesk',
        'Unlock' => 'שחרר נעילה',
        'Welcome %s %s' => '',
        'Counter' => 'מונה',
        ...
        'BuzzDesk as provider' => 'BuzzDesk כמספק',
        'Operations' => '',
        'BuzzDesk as requester' => 'BuzzDesk כמבקש',
        'Invokers' => '',
        ...
        'Install BuzzDesk' => 'התקנת BuzzDesk',
        'Intro' => 'מבוא',
        ...
        'BuzzDesk Version' => 'גרסת BuzzDesk',
