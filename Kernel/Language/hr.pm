...
sub Data {
    ...
    $Self->{Translation} = {
        ...
        'A new database user with limited permissions will be created for this BuzzDesk system.' =>
            'Novi korisnik baze sa ograničenim pravima bit će  kreiran za ovaj BuzzDesk sustav',
        'Repeat Password' => '',
        'Generated password' => '',
        ...
        'After doing so your BuzzDesk is up and running.' => 'Nakon ovoga Vaš BuzzDesk je uključen i radi.',
        ...
        'BuzzDesk Test Page' => 'BuzzDesk test stranica',
        'Unlock' => 'Otključano',
        'Welcome %s %s' => '',
        'Counter' => 'Brojač',
