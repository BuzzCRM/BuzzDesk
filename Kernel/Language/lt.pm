...
sub Data {
    ...
    $Self->{Translation} = {
        ...
        'A new database user with limited permissions will be created for this BuzzDesk system.' =>
            'Šiai BuzzDesk sistemai bus sukurtas naujas, apribotas teises turintis, duomenų bazės naudotojas.',
        'Repeat Password' => '',
        'Generated password' => '',
        ...
        'To be able to use BuzzDesk you have to enter the following line in your command line (Terminal/Shell) as root.' =>
            'Norėdami naudoti BuzzDesk turite root naudotojo teisėmis, komandinėje eilutėje (terminale), įvesti šią komandą.',
        'Restart your webserver' => 'Perkraukite savo web serverį',
        'After doing so your BuzzDesk is up and running.' => 'Atlikus šiuos veiksmus bus paleista BuzzDesk sistema.',
        ...
        'BuzzDesk Test Page' => 'BuzzDesk Bandomasis puslapis',
        'Unlock' => 'Atrakinti',
        'Welcome %s %s' => '',
        'Counter' => 'Skaitliukas',
        ...
        'Install BuzzDesk' => 'Įdiegti BuzzDesk',
        'Intro' => '',
