...
sub Data {
    ...
    $Self->{Translation} = {
        ...
        'The data from the invoker of BuzzDesk will be processed by this mapping, to transform it to the kind of data the remote system expects.' =>
            'Podaci iz BuzzDesk pozivaoca biće obrađeni ovim mapiranjem, da bi ih transformisali u tipove podataka koje udaljeni sistem očekuje.',
        ...
        'The response data will be processed by this mapping, to transform it to the kind of data the invoker of BuzzDesk expects.' =>
            'Podaci odgovora iz BuzzDesk pozivaoca biće obrađeni ovim mapiranjem, da bi ih transformisali u tipove podataka koje udaljeni sistem očekuje..',
        ...
        'Asynchronous event triggers are handled by the BuzzDesk Scheduler Daemon in background (recommended).' =>
            'Asinhronim okidačima događaja upravlja planer BuzzDesk sistemskog servisa u pozadini (preporučeno).',
        ...
        'The request data will be processed by this mapping, to transform it to the kind of data BuzzDesk expects.' =>
            'Podaci zahteva će biti obrađeni kroz mapiranje, radi transformacije u oblik koji BuzzDesk očekuje.',
        ...
        'Here you can specify the maximum size (in bytes) of REST messages that BuzzDesk will process.' =>
            'Ovde možete uneti maksimalnu veličinu (u bajtima) REST poruka koje će BuzzDesk da obradi.',
        ...
        'e.g. /opt/buzzdesk/var/certificates/SOAP/certificate.pem' => 'npr. /opt/buzzdesk/var/certificates/SOAP/certificate.pem',
        ...
        'e.g. /opt/buzzdesk/var/certificates/SOAP/key.pem' => 'npr. /opt/buzzdesk/var/certificates/SOAP/key.pem',
        ...
        'e.g. /opt/buzzdesk/var/certificates/SOAP/CA/ca.pem' => 'npr. /opt/buzzdesk/var/certificates/SOAP/CA/ca.pem',
        ...
        'e.g. /opt/buzzdesk/var/certificates/SOAP/CA' => 'npr. /opt/buzzdesk/var/certificates/SOAP/CA',
        ...
        'Here you can specify the maximum size (in bytes) of SOAP messages that BuzzDesk will process.' =>
            'Ovde možete uneti maksimalnu veličinu (u bajtima) SOAP poruka koje će BuzzDesk da obradi.',
        ...
        'In provider mode, BuzzDesk offers web services which are used by remote systems.' =>
            'U režimu provajdera, BuzzDesk nudi veb servise koji se koriste od strane udaljenih sistema.',
        'In requester mode, BuzzDesk uses web services of remote systems.' =>
            'U režimu naručioca, BuzzDesk koristi veb servise udaljenih sistema.',
        'Network transport' => 'Mrežni transport',
        ...
        'You can use BuzzDesk-tags like <OTRS_TICKET_DynamicField_...> to insert values from the current ticket.' =>
            'Možete koristiti BuzzDesk tagove kao <OTRS_TICKET_DynamicField_...> za umetanje vrednosti iz trenutnog tiketa.',
        ...
        'To be able to use PGP in BuzzDesk, you have to enable it first.' =>
            'Da bi mogli da koristite PGP u BuzzDesk, morate ga prvo omogućiti.',
        ...
        'Package installation requires a patch level update of BuzzDesk.' =>
            'Instalacija paketa zahteva ažuriranu verziju BuzzDesk.',
        'Package update requires a patch level update of BuzzDesk.' => 'Ažuriranje paketa zahteva ažuriranu verziju BuzzDesk.',
        'Please note that your installed BuzzDesk version is %s.' => 'Trenutno instalirana BuzzDesk verzija je %s.',
        'To install this package, you need to update BuzzDesk to version %s or newer.' =>
            'Da biste instalirali ovaj paket, neophodno je da ažurirate vaš BuzzDesk na verziju %s ili noviju.',
        'This package can only be installed on BuzzDesk version %s or older.' =>
            'Ovaj paket se može instalirati samo na BuzzDesk verziju%s ili stariju.',
        'This package can only be installed on BuzzDesk version %s.' => '',
        'Why should I keep BuzzDesk up to date?' => 'Zašto bi trebalo da BuzzDesk uvek bude ažuriran?',
        ...
        'You will receive updates for all other relevant BuzzDesk issues.' =>
            'Dobićete ažuriranja svih drugih relevantnih BuzzDesk izdanja.',
        'How can I do a patch level update if I don’t have a contract?' =>
            'Kako mogu da ažuriram verziju BuzzDesk ukoliko nemam ugovor?',
        ...
        'To be able to use SMIME in BuzzDesk, you have to enable it first.' =>
            'Da bi mogli da koristite SMIME u BuzzDesk, morate je prvo omogućiti.',
        ...
        'There are currently no settings available. Please make sure to run \'buzzdesk.Console.pl Maint::Config::Rebuild\' before using the software.' =>
            'Trenutno nema dostupnih podešavanja. Molimo proverite da li ste pokrenuli skript \'buzzdesk.Console.pl Maint::Config::Rebuild\' pre korišćenja aplikacije.',
        ...
        'The BuzzDesk Daemon is a daemon process that performs asynchronous tasks, e.g. ticket escalation triggering, email sending, etc.' =>
            'BuzzDesk servis je sistemski proces koji izvršava asinhrone poslove, npr. okidanje eskalacija tiketa, slanje imejlova, itd.',
        'A running BuzzDesk Daemon is mandatory for correct system operation.' =>
            'Pokrenut BuzzDesk sistemski servis je neophodan za ispravno funkcionisanje sistema.',
        'Starting the BuzzDesk Daemon' => 'Pokretanje BuzzDesk sistemskog servisa',
        'Make sure that the file \'%s\' exists (without .dist extension). This cron job will check every 5 minutes if the BuzzDesk Daemon is running and start it if needed.' =>
            'Osigurava da datoteka \'%s\' postoji (bez .dist ekstenzije). Ovaj kron posao će proveravati svakih 5 minuta da li BuzzDesk sistemski servis radi i pokreće ga ako je potrebno.',
        'Execute \'%s start\' to make sure the cron jobs of the \'buzzdesk\' user are active.' =>
            'Izvršite \'%s start\' da bi bili sigurni da su kron poslovi za BuzzDesk korisnika uvek aktivni.',
        'After 5 minutes, check that the BuzzDesk Daemon is running in the system (\'bin/buzzdesk.Daemon.pl status\').' =>
            'Posle 5 minuta, proverava da li BuzzDesk sistemski servis funkcioniše u sistemu (\'bin/buzzdesk.Daemon.pl status\').',
        ...
        'Create a new database for BuzzDesk' => 'Kreiraj novu bazu podataka za BuzzDesk',
        'Use an existing database for BuzzDesk' => 'Koristi postojeću bazu podataka za BuzzDesk',
        ...
        'A new database user with limited permissions will be created for this BuzzDesk system.' =>
            'Novi korisnik baze sa ograničenim pravima će biti kreiran za ovaj BuzzDesk sistem.',
        ...
        'To be able to use BuzzDesk you have to enter the following line in your command line (Terminal/Shell) as root.' =>
            'Da bi ste koristili BuzzDesk morate uneti sledeće u komandnu liniju (Terminal/Shell) kao root.',
        'Restart your webserver' => 'Ponovo pokrenite vaš veb server.',
        'After doing so your BuzzDesk is up and running.' => 'Posle ovoga vaš BuzzDesk je uključen i radi.',
        ...
        'This is the default public interface of BuzzDesk! There was no action parameter given.' =>
            'Ovo je podrazumevani javni interfejs za BuzzDesk! Nema datih akcionih parametara.',
        ...
        'BuzzDesk Test Page' => 'BuzzDesk test strana',
        'Unlock' => 'Otključaj',
        ...
        'ACLs could not be Imported due to a unknown error, please check BuzzDesk logs for more information' =>
            'ACL liste ne mogu da se uvezu zbog nepoznate greške, molimo da proverite BuzzDesk logove za više informacija',
        ...
        'Could not reset Dynamic Field order properly, please check the error log for more details.' =>
            'Nije moguće poništiti redosled dinamičkih polja, molimo da proverite BuzzDesk logove za više informacija.',
        ...
        'The imported file has not valid YAML content! Please check BuzzDesk log for details' =>
            'Uvezena datoteka nema ispravan YAML sadržaj! Molimo proverite BuzzDesk log za detalje',
        'Web service "%s" deleted!' => 'Veb servis "%s" je obrisan!',
        'BuzzDesk as provider' => 'BuzzDesk kao pružalac usluga',
        'Operations' => 'Operacije',
        'BuzzDesk as requester' => 'BuzzDesk kao naručilac',
        'Invokers' => 'Pozivaoci',
        ...
        'Sorry, Apache::Reload is needed as PerlModule and PerlInitHandler in Apache config file. See also scripts/apache2-httpd.include.conf. Alternatively, you can use the command line tool bin/buzzdesk.Console.pl to install packages!' =>
            'Žao nam je, ali Apache::Reload je neophodan kao PerlModule i PerlInitHandler u konfiguraciji Apache-a. Molimo pogledajte scripts/apache2-httpd.include.conf. Alternativno, možete koristiti konzolnu alatku bin/buzzdesk.Console.pl za instalaciju paketa!',
        ...
        'System Configuration could not be imported due to an unknown error, please check BuzzDesk logs for more information.' =>
            'Sistemska konfiguracija nije mogla biti uvežena zvog nepoznate greške, moliko proverite BuzzDesk logove za više informacija.',
        ...
        'Some imported settings are not present in the current state of the configuration or it was not possible to update them. Please check the BuzzDesk log for more information.' =>
            'Neka uvezena podešavanja nisu prisutna u trenutnoj konfiguraciji ili nije bilo moguće ažurirati ih. Molimo proverite BuzzDesk log za više informacija.',
        ...
        'Install BuzzDesk' => 'Instaliraj BuzzDesk',
        'Intro' => 'Uvod',
        ...
        'Install BuzzDesk - Error' => 'Instaliranje BuzzDesk - greška',
        ...
        'BuzzDesk Daemon is not running.' => 'BuzzDesk sistemski servis ne radi.',
        ...
        'Tables with invalid default values were found. In order to fix it automatically, please run: bin/buzzdesk.Console.pl Maint::Database::Check --repair' =>
            'Pronađene su tabele sa neispravnim podrazumevanim vrednostima. Da biste ih automatski ispravili, molimo pokrenite bin/buzzdesk.Console.pl Maint::Database::Check --repair',
        ...
        'BuzzDesk Disk Partition' => 'BuzzDesk particija na disku',

        # Perl Module: Kernel/System/SupportDataCollector/Plugin/OS/DiskSpace.pm
        'Disk Usage' => 'Korišćenje diska',
        'The partition where BuzzDesk is located is almost full.' => 'Particija na kojoj je smešten OTRS je skoro puna.',
        ...
        'BuzzDesk requires apache to be run with the \'prefork\' MPM model.' =>
            'BuzzDesk zahteva da Apache bude pokrenut sa \'prefork\' MPM modelom.',
        ...
        'The file system on your BuzzDesk partition is not writable.' => 'Nije moguće pisanje u sistem datoteka na vašoj BuzzDesk particiji.',
        ...
        'There are emails in var/spool that BuzzDesk could not process.' => 'Postoje imejlovi u var/spool koje BuzzDesk ne može da obradi.',
        ...
        'Table ticket_lock_index contains orphaned records. Please run bin/buzzdesk.Console.pl "Maint::Ticket::QueueIndexCleanup" to clean the StaticDB index.' =>
            'Tabela ticket_lock_index sadrži nepovezane zapise. Molimo da pokrenete bin/buzzdesk.Console.pl Maint::Ticket::QueueIndexCleanup da bi očistili StaticDB indeks.',
        ...
        'Table ticket_index contains orphaned records. Please run bin/buzzdesk.Console.pl "Maint::Ticket::QueueIndexCleanup" to clean the StaticDB index.' =>
            'Tabela ticket_lindex sadrži nepovezane zapise. Molimo da pokrenete bin/buzzdesk.Console.pl Maint::Ticket::QueueIndexCleanup da bi očistili StaticDB indeks.',
        ...
        'BuzzDesk time zone' => 'BuzzDesk vremenska zona',
        'BuzzDesk time zone is not set.' => 'BuzzDesk vremenska zona nije podešena.',
        ...
        'BuzzDesk Version' => 'BuzzDesk verzija',
        ...
        'BuzzDesk doesn\'t support recurring Appointments without end date or number of iterations. During import process, it might happen that ICS file contains such Appointments. Instead, system creates all Appointments in the past, plus Appointments for the next N months (120 months/10 years by default).' =>
            'BuzzDesk ne podržava termine koji se ponavljaju bez krajnjeg datuma ili broja iteracija. Prilikom uvoza kalendara, može se dogoditi da ICS datoteka sadrži takve \'beskonačne\' termine. Umesto takvog ponašanja, sistem će kreirati sve termine iz prošlosti, kao i termine za sledeći n broj meseci (podrazumevano 120 meseci/10 godina).',
        ...
        'Defines the module to display a notification in the agent interface if the BuzzDesk Daemon is not running.' =>
            'Određuje modul za prikaz obaveštenja u interfejsu operatera ako BuzzDesk sistemski servis ne radi.',
        ...
        'Type of daemon log rotation to use: Choose \'BuzzDesk\' to let BuzzDesk system to handle the file rotation, or choose \'External\' to use a 3rd party rotation mechanism (i.e. logrotate). Note: External rotation mechanism requires its own and independent configuration.' =>
            'Vrsta rotacije servisnog loga: izaberite \'BuzzDesk\' da dopustite BuzzDesk sistemu da rotira logove, ili \'Eksterno\' za drugi mehanizam rotacije (npr. logrotate). Napomena: ekterni rotacioni mehanizmi zahtevaju sopstvenu i nezavisnu konfiguraciju.',
        ...
        'Disables the web installer (http://yourhost.example.com/buzzdesk/installer.pl), to prevent the system from being hijacked. If not enabled, the system can be reinstalled and the current basic configuration will be used to pre-populate the questions within the installer script. If enabled, it also disables the GenericAgent, PackageManager and SQL Box.' =>
            'Onemogućuje pristup instalacionom ekranu (http://yourhost.example.com/buzzdesk/installer.pl) u svrhu zaštite sistema od nedozvoljenog preuzimanja. Ako je isključeno, sistem može biti ponovo instaliran i trenutna osnovna konfiguracija će biti korišćena da unapred popuni pitanja unutar instalacionog ekrana. Ukoliko nije uključeno, takođe se onemogućuju GenericAgent, PackageManager i SQL Box.',
        ...
        'Defines the system identifier. Every ticket number and http session string contains this ID. This ensures that only tickets which belong to your system will be processed as follow-ups (useful when communicating between two instances of BuzzDesk).' =>
            'Definiše identifikator sistema. Svaki broj tiketa i niz znakova „http” sesije sadrši ovaj ID. Ovo osigurava da će samo tiketi koji pripadaju vašem sistemu biti obrađeni kao operacije praćenja (korisno kada se odvija komunikacija između dve „BuzzDesk” instance).',
        ...
        'Defines the HTTP hostname for the support data collection with the public module \'PublicSupportDataCollector\' (e.g. used from the BuzzDesk Daemon).' =>
            'Definiše HTTP host za slanje podataka podrške preko javnog module \'PublicSupportDataCollector\' (npr. od strane BuzzDesk sistemskog servisa).',
        'Defines the timeout (in seconds, minimum is 20 seconds) for the support data collection with the public module \'PublicSupportDataCollector\' (e.g. used from the BuzzDesk Daemon).' =>
            'Definiše predviđeno vreme (u sekundama, minimum je 20 sekundi) za prikupljanje podataka podrške putem modula javog interfejsa \'PublicSupportDataCollector\' (npr. kad se koristi putem BuzzDesk sistemskog servisa).',
        ...
        'Defines the default front-end (HTML) theme to be used by the agents and customers. If you like, you can add your own theme. Please refer the administrator manual located at https://doc.buzzdesk.org/developer/general_information/themes.html.' =>
            'Određuje podrazumevanu temu glavnog interfejsa (HTML) koja će biti korišćena od strane operatera ili klijenata. Ukoliko želite možete dodati vašu ličnu temu. Molimo vas da pogledate uputstvo za administratora, koje se nalazi na https://doc.buzzdesk.org/developer/general_information/themes.html.',
        ...
        'Disable HTTP header "X-Frame-Options: SAMEORIGIN" to allow BuzzDesk to be included as an IFrame in other websites. Disabling this HTTP header can be a security issue! Only disable it, if you know what you are doing!' =>
            'Onemogućava HTTP zaglavlje "X-Frame-Options: SAMEORIGIN" radi učitavanja BuzzDesk u okviru IFRAME na drugim stranama. Onemogućavanje ovog HTTP zaglavlja snosi sigurnosni rizik! Isključite ga samo ako znate šta radite!',
        ...
        'Adds a suffix with the actual year and month to the BuzzDesk log file. A logfile for every month will be created.' =>
            'Dodaje tekuću godinu i mesec kao sufiks u BuzzDesk log datoteku. Biće kreirana log datoteka za svaki mesec.',
        ...
        'Defines the name of the session key. E.g. Session, SessionID or BuzzDesk.' =>
            'Definiše naziv ključa sesije. Npr. Session, SessionID ili BuzzDesk”',
        ...
        'Sets the time zone being used internally by BuzzDesk to e. g. store dates and times in the database. WARNING: This setting must not be changed once set and tickets or any other data containing date/time have been created.' =>
            'Podešava internu vremensku zonu BuzzDesk za npr. čuvanje datuma i vremena u bazi podataka. Upozorenje: ovo podešavanje ne smete menjati jednom kada ga podesite i ako su kreirani tiketi ili bilo koji drugi podaci sa vremenom.',
        'Sets the time zone that will be assigned to newly created users and will be used for users that haven\'t yet set a time zone. This is the time zone being used as default to convert date and time between the BuzzDesk time zone and the user\'s time zone.' =>
            'Podešava vremensku zonu koja će biti dodeljena novo-kreiranim korisnicima i koja će biti korišćena za one koji još nisu podesili vremensku zonu. Ovo je podrazumevana vremenska zona za konverziju datuma i vremena između interne BuzzDesk vremenske zone i vremenske zone korisnika.',
        ...
        'Defines the maximal size (in bytes) for file uploads via the browser. Warning: Setting this option to a value which is too low could cause many masks in your BuzzDesk instance to stop working (probably any mask which takes input from the user).' =>
            'Definiše maksimalnu veličinu (u bajtovima) za slanje datoteke preko pretraživača. Upozorenje: Podešavanje ove opcije na suviše malu vrednost može uzrokovati da mnoge maske u vašoj BuzzDesk instanci prestanu sa radom (verovatno svaka maska koja ima ulaz od korisnika).',
        ...
        'Enables PGP support. When PGP support is enabled for signing and encrypting mail, it is HIGHLY recommended that the web server runs as the BuzzDesk user. Otherwise, there will be problems with the privileges when accessing .gnupg folder.' =>
            'Obezbeđuje „PGP” podršku. Kada je „PGP” podrška omogućena za potpisivanje i enkriprovanje mejla, strogo se preporučuje da veb server radi kao „BuzzDesk” korisnik. U suprotnom, biće problema sa privilegijama prilikom pristupa „.gnupg” direktorijumu.',
        ...
        'Specifies the name that should be used by the application when sending notifications. The sender name is used to build the complete display name for the notification master (i.e. "BuzzDesk Notifications" buzzdesk@your.example.com).' =>
            'Definiše naziv koje će aplikacija koristiti prilikom slanja obaveštenja. Naziv se koristi u nazivu pošiljaoca obaveštenja (npr. "BuzzDesk Notifications" buzzdesk@your.example.com).',
        'Specifies the email address that should be used by the application when sending notifications. The email address is used to build the complete display name for the notification master (i.e. "BuzzDesk Notifications" buzzdesk@your.example.com). You can use the OTRS_CONFIG_FQDN variable as set in your configuation, or choose another email address.' =>
            'Definiše imejl adresu koju će aplikacija koristiti prilikom slanja obaveštenja. Imejl adresa se koristi u nazivu pošiljaoca obaveštenja (npr. "BuzzDesk Notifications" buzzdesk@your.example.com). Možete koristiti promenljivu OTRS_CONFIG_FQDN iz vaše konfiguracije, ili odredite drugu imejl adresu.',
        ...
        'If "LDAP" was selected for Customer::Authmodule, you can check if the user is allowed to authenticate because he is in a posixGroup, e.g. user needs to be in a group xyz to use BuzzDesk. Specify the group, who may access the system.' =>
            'Ukoliko je podešen „LDAP” za „Customer::AuthModule”, možete proveriti da li je korisniku omogućena autentikacija ako pripada „posixGroup”, npr. korisnik mora da pripada grupi xyz da bi mogao da koristi „BuzzDesk”. Definišite grupu sa pristupom sistemu.',
        ...
        'Defines the shown links in the footer area of the customer and public interface of this BuzzDesk system. The value in "Key" is the external URL, the value in "Content" is the shown label.' =>
            'Određuje prikazane veze u donjem delu klijentskog i javnog interfejsa ovog BuzzDesk sistema. Vrednost polja "Key" je eksterna adresa (URL), a vrednost polja "Content" je prikazan naziv.',
        ...
        'BuzzDesk can use one or more readonly mirror databases for expensive operations like fulltext search or statistics generation. Here you can specify the DSN for the first mirror database.' =>
            '„BuzzDesk” može da koristi jednu ili više preslikanih baza podataka za skupe operacije kao što su pretraga teksta ili generisanje statistika. Ovde možete definisati DSN za prvu preslikanu bazu podataka.',
        ...
        'Defines a filter for html output to add links behind CVE numbers. The element Image allows two input kinds. At once the name of an image (e.g. faq.png). In this case the BuzzDesk image path will be used. The second possiblity is to insert the link to the image.' =>
            'Definiše filter za html izlaz da bi ste dodali veze iza CVE brojeva. Element Image dozvoljava dva načina ulaza. U jednom naziv slike (npr. faq.png). I tom slučaju biće korišćena BuzzDesk putanja slike. Drugi način je unošenje veze do slike.',
        'Defines a filter for html output to add links behind bugtraq numbers. The element Image allows two input kinds. At once the name of an image (e.g. faq.png). In this case the BuzzDesk image path will be used. The second possiblity is to insert the link to the image.' =>
            'Definiše filter za HTML izlaz da bi ste dodali veze iza bugtraq brojeva. Element Image dozvoljava dva načina ulaza. U jednom naziv slike (npr. faq.png). I tom slučaju biće korišćena BuzzDesk putanja slike. Drugi način je unošenje putanje do slike.',
        'Defines a filter for html output to add links behind MSBulletin numbers. The element Image allows two input kinds. At once the name of an image (e.g. faq.png). In this case the BuzzDesk image path will be used. The second possiblity is to insert the link to the image.' =>
            'Definiše filter za html izlaz da bi ste dodali veze iza MSBulletin brojeva. Element Image dozvoljava dva načina ulaza. U jednom naziv slike (npr. faq.png). I tom slučaju biće korišćena BuzzDesk putanja slike. Drugi način je unošenje veze do slike.',
        'Define a filter for html output to add links behind a defined string. The element Image allows two input kinds. At once the name of an image (e.g. faq.png). In this case the BuzzDesk image path will be used. The second possiblity is to insert the link to the image.' =>
            'Definiši filter za html izlaz da bi dodali veze iza definisanog niza znakova. Element Image dozvoljava dva načina ulaza. U jednom naziv slike (npr. faq.png). U tom slučaju biće korišćena BuzzDesk putanja slike. Drugi način je unošenje veze do slike.',
        'Defines a filter for html output to add links behind a defined string. The element Image allows two input kinds. At once the name of an image (e.g. faq.png). In this case the BuzzDesk image path will be used. The second possiblity is to insert the link to the image.' =>
            'Definiše filter za html izlaz da bi ste dodali veze iza definisanog niza znakova. Element Image dozvoljava dva načina ulaza. U jednom naziv slike (npr. faq.png). I tom slučaju biće korišćena BuzzDesk putanja slike. Drugi način je unošenje veze do slike.',
        'If enabled, the BuzzDesk version tag will be removed from the Webinterface, the HTTP headers and the X-Headers of outgoing mails. NOTE: If you change this option, please make sure to delete the cache.' =>
            'Ako je aktivirano, oznaka BuzzDesk verzije će biti uklonjena iz veb interfejsa, HTTP zaglavlja i X-Headers u odlaznim imejl porukama. NAPOMENA: ako menjate ovu opciju, molimo da osigurate brisanje keša.',
        ...
        'If enabled, BuzzDesk will deliver all CSS files in minified form.' =>
            'Ukoliko je uključeno, BuzzDesk će isporučiti sve CSS datoteke u smanjenoj formi.',
        'If enabled, BuzzDesk will deliver all JavaScript files in minified form.' =>
            'Ukoliko je uključeno, BuzzDesk će isporučiti sve JavaScript datoteke u smanjenoj formi.',
        ...
        'Saves the attachments of articles. "DB" stores all data in the database (not recommended for storing big attachments). "FS" stores the data on the filesystem; this is faster but the webserver should run under the BuzzDesk user. You can switch between the modules even on a system that is already in production without any loss of data. Note: Searching for attachment names is not supported when "FS" is used.' =>
            'Čuva priloge u člancima. „DB” snima sve priloge u bazi podataka (nije preporučljivo za čuvanje velikih priloga). „FS” snima priloge u sistemu datoteka; ovo je brža opcija, ali veb server mora biti pokrenut pod „BuzzDesk” sistemskim korisnikom. Dozvoljena je promena modula čak i na produkcijskim sistemima bez bilo kakvog gubitka podataka. Napomena: pretraga priloga po nazivu nije moguća kada je „FS” u funkciji.',
        ...
        'Helps to extend your articles full-text search (From, To, Cc, Subject and Body search). It will strip all articles and will build an index after article creation, increasing fulltext searches about 50%. To create an initial index use "bin/buzzdesk.Console.pl Maint::Ticket::FulltextIndex --rebuild".' =>
            'Omogućuje proširenu tekstualnu pretragu vaših članaka (pretraga po poljima From, To, Cc, Subject i Body). Svi postojeći članci će biti reindeksirani, novi dodati u indeks pretrage po kreiranju, time ubrzavajući tekstualnu pretragu za oko 50%. Za kreiranje početnog indeksa koristite "bin/buzzdesk.Console.pl Maint::Ticket::FulltextIndexRebuild --rebuild".',
        ...
        'Basic fulltext index settings. Execute "bin/buzzdesk.Console.pl Maint::Ticket::FulltextIndex --rebuild" in order to generate a new index.' =>
            'Osnovno podešavanje indeksa celog teksta. Pokrenite "bin/buzzdesk.Console.pl Maint::Ticket::FulltextIndexRebuild --rebuild" kako bi se generisao novi indeks.',
        ...
        'Defines the valid states for unlocked tickets. To unlock tickets the script "bin/buzzdesk.Console.pl Maint::Ticket::UnlockTimeout" can be used.' =>
            'Određuje važeće statuse za otključane tikete. Za otključavanje tiketa može se koristiti skript "bin/buzzdesk.Console.pl Maint::Ticket::UnlockTimeout".',
        ...
        'Executes follow-up checks on BuzzDesk Header \'X-OTRS-Bounce\'.' =>
            'Izvršava provere nastavka na „BuzzDesk” zaglavlju „X-OTRS-Bounce”.',
        ...
        'This option is currently disabled because the BuzzDesk Daemon is not running.' =>
            'Ova funkcija je trenutno isključena zato što BuzzDesk servis ne radi.',
        ...
        'Information about the BuzzDesk Daemon' => 'Informacije o BuzzDesk sistemskom servisu',
