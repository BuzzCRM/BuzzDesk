...
επεξεργαστείτε τα πιστοποιητικά και ιδιωτικά κλειδιά στο αρχείο συστήματος.',
        ...
        'To be able to use BuzzDesk you have to enter the following line in your command line (Terminal/Shell) as root.' =>
            'Για να μπορεσετε να χρησιμοπιήσετε το BuzzDesk πρέπει να είσάγετε την παρακάτω γραμμή στο Terminal command line ώς χρήστης root.',
        'Restart your webserver' => 'Κανετε εποανεκίνηση του webserver.',
        'After doing so your BuzzDesk is up and running.' => 'Μετά απο αυτή την ενέργεια το BuzzDesk θα ενεργοποιηθεί.',
        ...
        'BuzzDesk Test Page' => 'BuzzDesk δοκιμαστική σελίδα',
        'Unlock' => 'Άνοιγμα',
        'Welcome %s %s' => '',
        'Counter' => 'Μετρητής',
        ...
        'BuzzDesk as provider' => 'BuzzDesk ως προμηθευτής',
        'Operations' => '',
        'BuzzDesk as requester' => 'BuzzDesk ως αιτούντας',
        'Invokers' => '',
        ...
        'Install BuzzDesk' => 'Εγκατασταση BuzzDesk',
        'Intro' => 'Εισαγωγή',
        ...
        'BuzzDesk Daemon is not running.' => 'Ο διεργασία παρασκηνίου του BuzzDesk δεν εκτελείται.',
