...
sub Data {
    ...
    $Self->{Completeness}        = 0.234854507870886;
    ...
    $Self->{Translation} = {
        ...
        'To be able to use BuzzDesk you have to enter the following line in your command line (Terminal/Shell) as root.' =>
            'Abyste mohli používat BuzzDesk, musíte zadat následující řádek do Vašeho příkazového řádku (Terminal/Shell) jako root.',
        'Restart your webserver' => 'Restartujte Váš webserver',
        'After doing so your BuzzDesk is up and running.' => 'Po dokončení následujících operací je Váš BuzzDesk spuštěn a poběží',
        ...
        'BuzzDesk Test Page' => 'Testovací BuzzDesk stránka',
        'Unlock' => 'Odemknout',
        'Welcome %s %s' => '',
        'Counter' => 'Počítadlo',
        ...
        'ACLs could not be Imported due to a unknown error, please check BuzzDesk logs for more information' =>
            'Z důvodu neznámé chyby ACL nemohly být naimportovány, pro více informací prosím zkontrolujte logy BuzzDesk',
        ...
        'BuzzDesk as provider' => 'BuzzDesk jako poskytovatel',
        'Operations' => '',
        'BuzzDesk as requester' => 'BuzzDesk jako žadatel',
        'Invokers' => '',
        ...
        'Install BuzzDesk' => 'Instalovat BuzzDesk',
        'Intro' => 'Úvod',
        ...
        'BuzzDesk Daemon is not running.' => 'BuzzDesk plánovač není spuštěn.',
        ...
        'BuzzDesk Disk Partition' => 'BuzzDesk diskový oddíl',

        # Perl Module: Kernel/System/SupportDataCollector/Plugin/OS/DiskSpace.pm
        'Disk Usage' => 'Využití disku',
        'The partition where BuzzDesk is located is almost full.' => 'Particie kde je umístněno BuzzDesk je téměř plná.',
        'The partition where BuzzDesk is located has no disk space problems.' =>
            'Na particii, kde je nainstalováno BuzzDesk není problém s diskovým prostorem.',
        ...
        'The file system on your BuzzDesk partition is not writable.' => 'Na souborový systém na vaší BuzzDesk particii není možné zapisovat.',
        ...
        'BuzzDesk Version' => 'Verze BuzzDesk ',
