...
sub Data {
    ...
    $Self->{Completeness}        = 0.318333598346319;
    ...
    $Self->{Translation} = {
        ...
        'To create a new ACL you can either import ACLs which were exported from another system or create a complete new one.' =>
            'För att skapa en ACL-regel kan du antingen importera ACL-regler som exporterats från en annan BuzzDesk-installation eller skapa en ny.',
        ...
        'To be able to use PGP in BuzzDesk, you have to enable it first.' =>
            'För att använda PGP i BuzzDesk, måste du aktivera det först.',
        ...
        'A running BuzzDesk Daemon is mandatory for correct system operation.' =>
            'BuzzDesk-demonen behöver köras för att systemet ska fungera som det ska.',
        'Starting the BuzzDesk Daemon' => 'Startar BuzzDesk-demonen',
        ...
        'After 5 minutes, check that the BuzzDesk Daemon is running in the system (\'bin/buzzdesk.Daemon.pl status\').' =>
            'Kontroller om fem minuter att BuzzDesk-demonen körs (\'bin/buzzdesk.Daemon.pl status\').',
        ...
        'Create a new database for BuzzDesk' => 'Skapa en ny databas för BuzzDesk-installationen',
        'Use an existing database for BuzzDesk' => 'Använd en existerande databas för BuzzDesk-installationen',
        ...
        'A new database user with limited permissions will be created for this BuzzDesk system.' =>
            'En ny databasanvändare med begränsade rättigheter kommer att skapas för BuzzDesk-installationen.',
        ...
        'To be able to use BuzzDesk you have to enter the following line in your command line (Terminal/Shell) as root.' =>
            'För att kunna använda BuzzDesk, måste följende rad skrivas på kommandoraden som root.',
        'Restart your webserver' => 'Starta om din webbserver',
        'After doing so your BuzzDesk is up and running.' => 'Efter detta är BuzzDesk igång.',
        ...
        'System FQDN' => ' BuzzDesk-installationens värdnamn (FQDN)',
        ...
        'BuzzDesk Test Page' => 'BuzzDesk Test-sida',
        'Unlock' => 'Lås upp',
        ...
        'BuzzDesk as provider' => 'BuzzDesk-installationen svarar på request (tillhandahållare)',
        'Operations' => '',
        'BuzzDesk as requester' => 'BuzzDesk-installationen skickar request',
        'Invokers' => '',
        ...
        'Install BuzzDesk' => 'Installera BuzzDesk',
        'Intro' => 'Intro',
        ...
        'Contact your Admin!' => '',
        'System Settings' => 'Inställningar för BuzzDesk-installationen',
        'Syslog' => '',
        ...
        'BuzzDesk Daemon is not running.' => 'BuzzDesk-demonen körs inte.',
        ...
        'BuzzDesk Disk Partition' => 'BuzzDesk diskpartition',
        ...
        'Daemon' => '',
        'Daemon is running.' => '',
        'Daemon is not running.' => 'BuzzDesk-demonen körs inte.',
        ...
        'The file system on your BuzzDesk partition is not writable.' => 'Filsystemet på din BuzzDesk-partition är inte skrivbart.',
        ...
        'Your SystemID setting is invalid, it should only contain digits.' =>
            'BuzzDesk-installationens system-ID är ogiltigt. Det ska enbart bestå av siffror.',
        ...
        'Main menu registration.' => 'Huvudmeny för registrering av BuzzDesk-installationen.',
        ...
        'Default ticket ID used by the system in the customer interface.' =>
            'Ärende-ID att användas av BuzzDesk-installationen i kundgränssnittet.',
        ...
        'Information about the BuzzDesk Daemon' => 'Information om BuzzDesk-demonen',
...
' => '',
        ...
        'We are performing scheduled maintenance. We should be back online shortly.' =>
            'Schemalagt underhåll pågår. BuzzDesk-instansen är snart tillgänglig igen.',
        'Web' => '',
