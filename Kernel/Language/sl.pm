...
sub Data {
    ...
    $Self->{Translation} = {
        ...
        'A new database user with limited permissions will be created for this BuzzDesk system.' =>
            'Novi uporabnik baze z omejenimi pravicami bo ustvarjen za ta BuzzDesk sistem',
        'Repeat Password' => '',
        'Generated password' => '',
        ...
        'To be able to use BuzzDesk you have to enter the following line in your command line (Terminal/Shell) as root.' =>
            'Da biste mogli koristiti BuzzDesk morate unijeti slijedeću liniju u Vašu komandnu liniju (Terminal/Shell) kao "root".',
        'Restart your webserver' => 'Ponovno zaženite Vaš WEB Server.',
        'After doing so your BuzzDesk is up and running.' => 'Po tem bo vaš BuzzDesk pripravljen na delo.',
        ...
        'BuzzDesk Test Page' => 'BuzzDesk testna stran',
        'Unlock' => 'Sprosti',
        'Welcome %s %s' => '',
        'Counter' => 'Števec',
        ...
        'Install BuzzDesk' => 'Namesti BuzzDesk',
        'Intro' => 'Uvod',
        ...
        'The partition where BuzzDesk is located is almost full.' => 'Razdelek kjer je nameščen BuzzDesk je skoraj poln.',
        ...
        'BuzzDesk Version' => 'Verzija BuzzDesk',
